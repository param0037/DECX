...
void MatMul_CPU()
{
    ...
    de::Matrix& A = de::CreateMatrixRef(de::_FP32_, L, H, 0);
    de::Matrix& B = de::CreateMatrixRef(de::_FP32_, W, L, 0);
    de::Matrix& dst = de::CreateMatrixRef(de::_FP32_, W, H, 0);
...
void MatMul_GPU_CPL32()
{
    ...
    de::Matrix& A = de::CreateMatrixRef(de::_COMPLEX_F32_, L, H, 0);
    de::Matrix& B = de::CreateMatrixRef(de::_COMPLEX_F32_, W, L, 0);
    de::Matrix& C = de::CreateMatrixRef(de::_COMPLEX_F32_, W, H, 0);
    de::Matrix& dst = de::CreateMatrixRef(de::_COMPLEX_F32_, W, H, 0);
