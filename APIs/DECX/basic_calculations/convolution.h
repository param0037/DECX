...
namespace de
{
	...
	namespace cuda
	{
		_DECX_API_ de::DH Filter2D(de::Matrix& src, de::Matrix& kernel, de::Matrix& dst, const uint conv_flag, const int accu_flag);


		_DECX_API_ de::DH Filter2D(de::GPU_Matrix& src, de::GPU_Matrix& kernel, de::GPU_Matrix& dst, const uint conv_flag, const int accu_flag);


		_DECX_API_ de::DH Filter2D_single_kernel(
			de::GPU_MatrixArray& src, de::GPU_Matrix& kernel, de::GPU_MatrixArray& dst, const int conv_flag, const int accu_flag);


		_DECX_API_ de::DH Filter2D_multi_kernel(
	...
	namespace cpu
	{
		_DECX_API_ de::DH Filter2D(de::Matrix& src, de::Matrix& kernel, de::Matrix& dst, const int flag, const int _output_type);
