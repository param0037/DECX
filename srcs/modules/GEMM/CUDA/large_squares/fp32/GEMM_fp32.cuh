    ...
    namespace gemm {
        namespace GPUK {
            ...
            __global__
                ...
                */
                void cu_GEMM_fp32_spec(float4* A, float4* B, float4* dst,
            ...
            __global__
                ...
                * @param __iter : __linear(in float) / 16
                */
                void cu_GEMM_fp32_ABC_spec(float4* A, float4* B, float4* C, float4* dst,
                    const uint pitch_A, const uint pitch_B, const uint __iter);
            ...
            __global__
                ...
                * @param __iter : __linear(in float) / 16
                */
                void cu_GEMM_fp32_anyWH_specL(float4* A, float4* B, float4* dst,
            ...
            __global__
                ...
                * @param __iter : __linear(in float) / 16
                */
                void cu_GEMM_fp32_ABC_anyWH_specL(float4* A, float4* B, float4* C, float4* dst,
                    const uint pitch_A, const uint pitch_B, const uint Hdst, const uint __iter);
            ...
            __global__
                ...
                * @param __iter : __linear(in float) / 16
                */
                void cu_GEMM_fp32_anyWH_anyL(float4* A, float4* B, float4* dst,
            ...
            __global__
                ...
                * @param __iter : __linear(in float) / 16
                */
                void cu_GEMM_fp32_ABC_anyWH_anyL(float4* A, float4* B, float4* C, float4* dst,
                    const uint pitch_A, const uint pitch_B, const uint Hdst, const uint HB, const uint __iter);
            ...
            __global__
                ...
                * @param __iter : __linear(in float) / 16
                */
                void cu_GEMM_fp32_specWH_anyL(float4* A, float4* B, float4* dst,
            ...
            __global__
                ...
                * @param __iter : __linear(in float) / 16
                */
                void cu_GEMM_fp32_ABC_specWH_anyL(float4* A, float4* B, float4* C, float4* dst,
                    const uint pitch_A, const uint pitch_B, const uint HB, const uint __iter);
