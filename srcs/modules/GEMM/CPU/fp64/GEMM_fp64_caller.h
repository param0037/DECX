...
#include "GEMM_Matrix_B_arrange_fp64.h"
#include "../../../classes/classes_util.h"
#include "GEMM_organizer_fp64.h"
#include "GEMM_ABC_organizer_fp64.h"
...
namespace decx
{
    namespace cpu
    {
        static void GEMM_fp64(de::Matrix& A, de::Matrix& B, de::Matrix& dst, de::DH *handle);


        static void GEMM_fp64_ABC(de::Matrix& A, de::Matrix& B, de::Matrix& C, de::Matrix& dst, de::DH *handle);
    }
}


void decx::cpu::GEMM_fp64(de::Matrix& A, de::Matrix& B, de::Matrix& dst, de::DH* handle)
{
    ...
    if (is_L8) {
        ...
        decx::GEMM_AB_fp64_caller_8x((double*)_A->Mat.ptr, arranged_B.ptr, (double*)_dst->Mat.ptr, extra_dst.ptr, _A->pitch, arranged_B_dims.x, _dst->pitch,
        ...
        // execute the GEMM_fp32 kernels
        decx::GEMM_AB_fp64_caller_16x((double*)_A->Mat.ptr, arranged_B.ptr, (double*)_dst->Mat.ptr, _A->pitch, arranged_B_dims.x, _dst->pitch,
...
void decx::cpu::GEMM_fp64_ABC(de::Matrix& A, de::Matrix& B, de::Matrix& C, de::Matrix& dst, de::DH* handle)
{
    decx::_Matrix* _A = dynamic_cast<decx::_Matrix*>(&A);
    decx::_Matrix* _B = dynamic_cast<decx::_Matrix*>(&B);
    ...
    if (is_L8) {
        ...
        decx::GEMM_ABC_fp64_caller_8x((double*)_A->Mat.ptr, arranged_B.ptr, (double*)_C->Mat.ptr, (double*)_dst->Mat.ptr, extra_dst.ptr, 
        ...
        // execute the GEMM_fp64 kernels
        decx::GEMM_ABC_fp64_caller_16x((double*)_A->Mat.ptr, arranged_B.ptr, (double*)_C->Mat.ptr, (double*)_dst->Mat.ptr, 
            _A->pitch, arranged_B_dims.x, _C->pitch, _dst->pitch,
            make_uint2(_B->pitch / 8, _dst->height), _A->pitch, &t2D);
    }
    // deallocate temporary space of arranged matrix B
