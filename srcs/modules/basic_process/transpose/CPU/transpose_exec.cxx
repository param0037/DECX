...
void decx::bp::transpose_4x4_caller(const float* src, float* dst, const uint2 proc_dim_src, const uint Wsrc, const uint Wdst)
{
    ...
    for (int i = 0; i < t1D.total_thread - 1; ++i) {
        t1D._async_thread[i] = decx::cpu::register_task(&decx::thread_pool, decx::bp::CPUK::transpose_4x4_b32,
    ...
    t1D._async_thread[t1D.total_thread - 1] = decx::cpu::register_task(&decx::thread_pool, decx::bp::CPUK::transpose_4x4_b32_LH,
...
void decx::bp::transpose_2x2_caller(const double* src, double* dst, const uint2 proc_dim_src, const uint Wsrc, const uint Wdst)
{
    ...
    for (int i = 0; i < t1D.total_thread - 1; ++i) {
        t1D._async_thread[i] = decx::cpu::register_task(&decx::thread_pool, decx::bp::CPUK::transpose_2x2_b64,
    ...
    const uint _L = f_mgr.is_left ? f_mgr.frag_left_over : f_mgr.frag_len;
    t1D._async_thread[t1D.total_thread - 1] = decx::cpu::register_task(&decx::thread_pool, decx::bp::CPUK::transpose_2x2_b64_LH,
