...
_DECX_API_ de::DH de::cpu::TypeCast(de::Vector& src, de::Vector& dst, const int cvt_method)
{
    ...
    if (cvt_method == TypeCast_Method::CVT_FP32_FP64) {
        ...
        decx::type_cast::_cvtfp32_i32_caller((float*)_src->Vec.ptr, (float*)_dst->Vec.ptr, _src->_length);
    }
    else if (cvt_method == TypeCast_Method::CVT_INT32_FP32) {
        decx::type_cast::_cvti32_fp32_caller((float*)_src->Vec.ptr, (float*)_dst->Vec.ptr, _src->_length);
    }
        ...
        decx::type_cast::_cvtf32_ui8_caller1D((float*)_src->Vec.ptr, (int*)_dst->Vec.ptr, _src->_length / 8, cvt_method, &handle);
    }
    else if (cvt_method == CVT_UINT8_FP32) {
        decx::type_cast::_cvtui8_f32_caller1D((float*)_src->Vec.ptr, (float*)_dst->Vec.ptr, _src->_length / 8);
    }
    else {
