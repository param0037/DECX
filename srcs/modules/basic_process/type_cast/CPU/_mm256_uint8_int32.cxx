                                           ...
                                           const size_t         proc_len)
{
    ...
    if (_is_MT) {
        ...
        for (int i = 0; i < t1D.total_thread - 1; ++i) {
            t1D._async_thread[i] = decx::cpu::register_task(&decx::thread_pool, decx::type_cast::CPUK::_v256_cvtui8_i32_1D,
        ...
        t1D._async_thread[t1D.total_thread - 1] = decx::cpu::register_task(&decx::thread_pool, decx::type_cast::CPUK::_v256_cvtui8_i32_1D,
            loc_src, loc_dst, _L);
                                           ...
                                           de::DH*              handle)
{
    ...
    switch (flag)
    {
    case (CVT_INT32_UINT8_CLAMP_TO_ZERO | CVT_INT32_UINT8_TRUNCATE):        // 14
        exec_kernrel_ptr = decx::type_cast::CPUK::_v256_cvti32_ui8_truncate_clamp_zero1D;
        break;

    case CVT_INT32_UINT8_TRUNCATE:      // 6
        exec_kernrel_ptr = decx::type_cast::CPUK::_v256_cvti32_ui8_truncate1D;
        break;

    case CVT_INT32_UINT8_CYCLIC:        // 7
        exec_kernrel_ptr = decx::type_cast::CPUK::_v256_cvti32_ui8_cyclic1D;
        break;

    case CVT_INT32_UINT8_SATURATED:     // 8
        exec_kernrel_ptr = decx::type_cast::CPUK::_v256_cvti32_ui8_saturated1D;
        break;

    case (CVT_INT32_UINT8_CYCLIC | CVT_INT32_UINT8_CLAMP_TO_ZERO):      // 15
        exec_kernrel_ptr = decx::type_cast::CPUK::_v256_cvti32_ui8_cyclic1D;
        break;

    case (CVT_INT32_UINT8_SATURATED | CVT_INT32_UINT8_CLAMP_TO_ZERO):   // 10
        exec_kernrel_ptr = decx::type_cast::CPUK::_v256_cvti32_ui8_saturated1D;
        break;
    ...
    if (_is_MT) {
        ...
        for (int i = 0; i < t1D.total_thread - 1; ++i) {
            t1D._async_thread[i] = decx::cpu::register_task(&decx::thread_pool, exec_kernrel_ptr,
                loc_src, loc_dst, f_mgr.frag_len);
        ...
        t1D._async_thread[t1D.total_thread - 1] = decx::cpu::register_task(&decx::thread_pool, exec_kernrel_ptr,
            loc_src, loc_dst, _L);
                                           ...
                                           const uint           Wdst)
{
    ...
    for (int i = 0; i < t1D.total_thread - 1; ++i) {
        t1D._async_thread[i] = decx::cpu::register_task(&decx::thread_pool, decx::type_cast::CPUK::_v256_cvtui8_i32_2D,
    ...
    const uint _L = f_mgr.is_left ? f_mgr.frag_left_over : f_mgr.frag_len;
    t1D._async_thread[t1D.total_thread - 1] = decx::cpu::register_task(&decx::thread_pool, decx::type_cast::CPUK::_v256_cvtui8_i32_2D,
