                                           ...
                                           const size_t         proc_len)
{
    ...
    if (_is_MT) {
        ...
        for (int i = 0; i < t1D.total_thread - 1; ++i) {
            t1D._async_thread[i] = decx::cpu::register_task(&decx::thread_pool, decx::type_cast::CPUK::_v256_cvtui8_f32_1D,
        ...
        t1D._async_thread[t1D.total_thread - 1] = decx::cpu::register_task(&decx::thread_pool, decx::type_cast::CPUK::_v256_cvtui8_f32_1D,
            loc_src, loc_dst, _L);
...
void decx::type_cast::_cvtui8_f32_caller2D(const float*         src, 
                                           ...
                                           const uint           Wdst)
{
    if (proc_dims.y < decx::cpI.cpu_concurrency) {
        ...
        for (int i = 0; i < t1D.total_thread - 1; ++i) {
            t1D._async_thread[i] = decx::cpu::register_task(&decx::thread_pool, decx::type_cast::CPUK::_v256_cvtui8_f32_2D,
        ...
        const uint _L = f_mgr.is_left ? f_mgr.frag_left_over : f_mgr.frag_len;
        t1D._async_thread[t1D.total_thread - 1] = decx::cpu::register_task(&decx::thread_pool, decx::type_cast::CPUK::_v256_cvtui8_f32_2D,
