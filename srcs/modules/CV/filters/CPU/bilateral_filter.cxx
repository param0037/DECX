    ...
    const float sigma_space, const float sigma_color, const int border_type)
{
    ...
    case decx::_DATA_TYPES_FLAGS_::_UINT8_:
        ...
        {
            _dst->re_construct(_src->Type(), _src->Width() - neighbor_dims.x + 1, _src->Height() - neighbor_dims.y + 1, _src->get_store_type());
            ...
            _dst->re_construct(_src->Type(), _src->Width(), _src->Height(), _src->get_store_type());
