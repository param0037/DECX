...
static void decx::rcp::_rcp2_CCOEFF_uint8(decx::_Matrix* src, decx::_Matrix* kernel, decx::_Matrix* dst, de::DH* handle)
{
    ...
    decx::rcp::CPUK::_template_normalize_uint8_cpy2D((uint8_t*)kernel->Mat.ptr, tmp_ker.ptr, kernel->_element_num / 8,
    ...
    if (is_norm) {
        ...
        float _sqrt_k_sum = 0;
        decx::rcp::CPUK::_template_sq_sum_vec8_fp32(tmp_ker.ptr, kernel->_element_num / 8, &_sqrt_k_sum);
