...
template void decx::conv_I2R::conv2_BC_im2col_fp16<false>(decx::_GPU_Tensor* src, decx::_GPU_TensorArray* kernel,
    decx::_GPU_Tensor* dst, const int accu_flag, decx::cuda_stream* S, decx::cuda_event* E, de::DH* handle);
...
template void decx::conv_I2R::conv2_BC_im2col_fp16_stride<false>(decx::_GPU_Tensor* src, decx::_GPU_TensorArray* kernel,
    decx::_GPU_Tensor* dst, const int accu_flag, decx::cuda_stream* S, decx::cuda_event* E, const uint2 strideXY, de::DH* handle);