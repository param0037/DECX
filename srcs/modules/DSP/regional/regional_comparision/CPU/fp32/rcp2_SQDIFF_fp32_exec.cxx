                                 ...
                                 const uint                  _loop)
{
    ...
    if (f_mgr->frag_left_over != 0) {
        ...
        for (int i = 0; i < t1D->total_thread - 1; ++i) {
            t1D->_async_thread[i] = decx::cpu::register_task_default( decx::rcp::CPUK::_rcp2_SQDIFF_rN_fp32_ST,
        ...
        t1D->_async_thread[t1D->total_thread - 1] = decx::cpu::register_task_default(decx::rcp::CPUK::_rcp2_SQDIFF_rN_fp32_ST,
            tmp_src_ptr, kernel, tmp_dst_ptr,
                                               ...
                                               decx::utils::frag_manager*  f_mgr)
{
    ...
    if (f_mgr->frag_left_over != 0) {
        ...
        for (int i = 0; i < t1D->total_thread - 1; ++i) {
            t1D->_async_thread[i] = decx::cpu::register_task_default(decx::rcp::CPUK::_rcp2_SQDIFF_r1_r4_fp32_ST,
                tmp_src_ptr, kernel, tmp_dst_ptr,
        ...
        t1D->_async_thread[t1D->total_thread - 1] = decx::cpu::register_task_default(decx::rcp::CPUK::_rcp2_SQDIFF_r1_r4_fp32_ST,
            tmp_src_ptr, kernel, tmp_dst_ptr,
                                 ...
                                 const uint                  _loop)
{
    ...
    if (f_mgr->frag_left_over != 0) {
        ...
        for (int i = 0; i < t1D->total_thread - 1; ++i) {
            t1D->_async_thread[i] = decx::cpu::register_task_default( decx::rcp::CPUK::_rcp2_SQDIFF_norm_rN_fp32_ST,
        ...
        t1D->_async_thread[t1D->total_thread - 1] = decx::cpu::register_task_default(decx::rcp::CPUK::_rcp2_SQDIFF_norm_rN_fp32_ST,
            tmp_src_ptr, kernel, tmp_dst_ptr, _sqrt_k_sum,
            make_uint2(proc_dim.x, f_mgr->frag_left_over), ker_dims, Wsrc, Wdst, reg_WL, _loop);
    }
    else {
                                               ...
                                               decx::utils::frag_manager*  f_mgr)
{
    ...
    if (f_mgr->frag_left_over != 0) {
        ...
        for (int i = 0; i < t1D->total_thread - 1; ++i) {
            t1D->_async_thread[i] = decx::cpu::register_task_default(decx::rcp::CPUK::_rcp2_SQDIFF_norm_r1_r4_fp32_ST,
                tmp_src_ptr, kernel, tmp_dst_ptr, _sqrt_k_sum,
                make_uint2(proc_dim.x, f_mgr->frag_len), ker_dims, Wsrc, Wdst);
        ...
        t1D->_async_thread[t1D->total_thread - 1] = decx::cpu::register_task_default(decx::rcp::CPUK::_rcp2_SQDIFF_norm_r1_r4_fp32_ST,
            tmp_src_ptr, kernel, tmp_dst_ptr, _sqrt_k_sum,
            make_uint2(proc_dim.x, f_mgr->frag_left_over), ker_dims, Wsrc, Wdst);
    }
    else {
