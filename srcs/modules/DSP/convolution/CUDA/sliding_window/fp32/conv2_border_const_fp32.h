...
#ifndef _CONV2_BORDER_CONST_H_
#define _CONV2_BORDER_CONST_H_
...
namespace decx
{
    namespace conv {
        ...
        static void _conv2_fp32_BC_pre_process(decx::conv::_cuda_conv2_fp32_preset* _conv2_preset, de::DH* handle);
        ...
        */
        static void _Conv2_BC_R8x8(decx::conv::_cuda_conv2_fp32_preset *_conv2_preset, de::DH* handle);
        ...
        * In order to save the device memory, just allocate memory of suitable size
        */
        static void _Conv2_BC_R16x16(decx::conv::_cuda_conv2_fp32_preset *_conv2_preset, de::DH* handle);
        ...
        * In order to save the device memory, just allocate memory of suitable size
        */
        static void _Conv2_BC_R8x16(decx::conv::_cuda_conv2_fp32_preset *_conv2_preset, de::DH* handle);
        ...
        * In order to save the device memory, just allocate memory of suitable size
        */
        static void _Conv2_BC_R16x8(decx::conv::_cuda_conv2_fp32_preset *_conv2_preset, de::DH* handle);


        template <bool _print>
        static void conv2_fp32_border_zero(decx::_Matrix* src, decx::_Matrix* kernel, decx::_Matrix* dst, de::DH* handle);
    }
}


template <bool _print, uint _bound_H, uint _bound_W, bool _for_MK>
static void decx::conv::_conv2_fp32_BC_pre_process(decx::conv::_cuda_conv2_fp32_preset*     _conv2_preset, 
                                                   de::DH*                                  handle)
{
    decx::conv::_cuConv2_kernel_params* k_params = &_conv2_preset->_Kparams;

    decx::conv::_cuda_conv2_fp32_BC_buf_dims_config<_bound_H, _bound_W>(k_params);
...
template <bool _print>
static void decx::conv::_Conv2_BC_R8x8(decx::conv::_cuda_conv2_fp32_preset *_conv2_preset, de::DH* handle)
{
    ...
    /*checkCudaErrors(cudaMemcpyAsync(_conv2_preset->_Kparams._dst_confs._ptr, _conv2_preset->dst_buf.ptr, 
        dst->_total_bytes, cudaMemcpyDeviceToHost, _conv2_preset->S->get_raw_stream_ref()));*/
...
template <bool _print>
static void decx::conv::_Conv2_BC_R16x16(decx::conv::_cuda_conv2_fp32_preset *_conv2_preset, de::DH* handle)
{
    ...
    /*checkCudaErrors(cudaMemcpyAsync(_conv2_preset->_Kparams._dst_confs.ptr, _conv2_preset->dst_buf.ptr,
        dst->_total_bytes, cudaMemcpyDeviceToHost, _conv2_preset->S->get_raw_stream_ref()));*/
...
template <bool _print>
static void decx::conv::_Conv2_BC_R8x16(decx::conv::_cuda_conv2_fp32_preset *_conv2_preset, de::DH* handle)
{
...
template <bool _print>
static void decx::conv::_Conv2_BC_R16x8(decx::conv::_cuda_conv2_fp32_preset *_conv2_preset, de::DH* handle)
{
...
template <bool _print>
static void decx::conv::conv2_fp32_border_zero(decx::_Matrix* src, decx::_Matrix* kernel, decx::_Matrix* dst, de::DH* handle)
{
    int2 half_ker_dim;
    ...
    if (half_ker_dim.x < bounded_kernel_R8 + 1) {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            decx::conv::_Conv2_BC_R8x8<_print>(&_conv2_preset, handle);
        }
        else {
            decx::conv::_Conv2_BC_R16x8<_print>(&_conv2_preset, handle);
        }
    }
    else {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            decx::conv::_Conv2_BC_R8x16<_print>(&_conv2_preset, handle);
        }
        else {
            decx::conv::_Conv2_BC_R16x16<_print>(&_conv2_preset, handle);
        }
    }
