...
namespace decx
{
    namespace conv 
    {
        ...
        */
        static void _dev_conv2_fp32_NB_R8x8(decx::conv::_cuda_conv2_fp32_preset* _conv2_preset, de::DH* handle);
        ...
        * In order to save the device memory, just allocate memory of suitable size
        */
        static void _dev_conv2_fp32_NB_R16x16(decx::conv::_cuda_conv2_fp32_preset* _conv2_preset, de::DH* handle);
        ...
        * In order to save the device memory, just allocate memory of suitable size
        */
        static void _dev_conv2_fp32_NB_R8x16(decx::conv::_cuda_conv2_fp32_preset* _conv2_preset, de::DH* handle);
        ...
        * In order to save the device memory, just allocate memory of suitable size
        */
        static void _dev_conv2_fp32_NB_R16x8(decx::conv::_cuda_conv2_fp32_preset* _conv2_preset, de::DH* handle);


        template <bool _print>
        static void dev_conv2_fp32_border_ignore(decx::_GPU_Matrix* src, decx::_GPU_Matrix* kernel, decx::_GPU_Matrix* dst, de::DH* handle);
    }
}
...
decx::conv::_dev_conv2_fp32_NB_R8x8(decx::conv::_cuda_conv2_fp32_preset* _conv2_preset, de::DH* handle)
{
...
template <bool _print> static void
decx::conv::_dev_conv2_fp32_NB_R16x16(decx::conv::_cuda_conv2_fp32_preset* _conv2_preset, de::DH* handle)
{
...
template <bool _print> static void
decx::conv::_dev_conv2_fp32_NB_R8x16(decx::conv::_cuda_conv2_fp32_preset* _conv2_preset, de::DH* handle)
{
...
template <bool _print> static void
decx::conv::_dev_conv2_fp32_NB_R16x8(decx::conv::_cuda_conv2_fp32_preset* _conv2_preset, de::DH* handle)
{
...
template <bool _print> static void
decx::conv::dev_conv2_fp32_border_ignore(decx::_GPU_Matrix* src, decx::_GPU_Matrix* kernel, decx::_GPU_Matrix* dst, de::DH* handle)
{
    int2 half_ker_dim;
    ...
    if (half_ker_dim.x < bounded_kernel_R8 + 1) {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            decx::conv::_dev_conv2_fp32_NB_R8x8<_print>(&_conv2_preset, handle);
        }
        else {
            decx::conv::_dev_conv2_fp32_NB_R16x8<_print>(&_conv2_preset, handle);
        }
    }
    else {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            decx::conv::_dev_conv2_fp32_NB_R8x16<_print>(&_conv2_preset, handle);
        }
        else {
            decx::conv::_dev_conv2_fp32_NB_R16x16<_print>(&_conv2_preset, handle);
        }
    }
