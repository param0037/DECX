...
namespace decx
{
    namespace conv {
        ...
        static void filter2D_uc8_SK_organiser(decx::_MatrixArray* src, decx::_Matrix* kernel, decx::_MatrixArray* dst, 
            const int conv_flag, const int output_type, de::DH* handle);
    ...
    const int conv_flag, const int output_type, de::DH* handle)
{
    ...
    case decx::bp::extend_label::_EXTEND_NONE_:
        dst->re_construct(output_type, src->Width() - kernel->Width() + 1,
            src->Height() - kernel->Height() + 1, src->MatrixNumber(), src->get_store_type());

        _ccac._Kparams._dst_confs.gen_matrix_configs(dst);

        if (output_type == decx::_DATA_TYPES_FLAGS_::_UINT8_) {
    ...
    case decx::bp::extend_label::_EXTEND_CONSTANT_:
        dst->re_construct(output_type, src->Width(), src->Height(), src->MatrixNumber(), src->get_store_type());
    ...
    const int conv_flag, de::DH* handle)
{
    ...
    case decx::bp::extend_label::_EXTEND_CONSTANT_:
        dst->re_construct(decx::_DATA_TYPES_FLAGS_::_FP32_, src->Width(), src->Height(), src->MatrixNumber(), src->get_store_type());
    ...
    const int conv_flag, const int _accu_flag, de::DH* handle)
{
    ...
    {
    case decx::bp::extend_label::_EXTEND_NONE_:
        dst->re_construct(decx::_DATA_TYPES_FLAGS_::_FP16_, src->Width() - kernel->Width() + 1,
            src->Height() - kernel->Height() + 1, src->MatrixNumber(), src->get_store_type());
    ...
    case decx::bp::extend_label::_EXTEND_CONSTANT_:
        dst->re_construct(decx::_DATA_TYPES_FLAGS_::_FP16_, src->Width(), src->Height(), src->MatrixNumber(), src->get_store_type());
...
//
//_DECX_API_ void
//decx::cuda::Filter2D_MC_SK_Raw_API(decx::_MatrixArray* src, decx::_Matrix* kernel, decx::_MatrixArray* dst,
...
//    {
//    case decx::_DATA_TYPES_FLAGS_::_UINT8_:
//        decx::conv::filter2D_uc8_SK_organiser<false>(src, kernel, dst, conv_flag, output_type, handle);
//        break;
//
//    case decx::_DATA_TYPES_FLAGS_::_FP32_:
//        decx::conv::filter2D_fp32_SK_organiser<false>(src, kernel, dst, conv_flag, handle);
//        break;
//
//    case decx::_DATA_TYPES_FLAGS_::_FP16_:
//        decx::conv::filter2D_fp16_SK_organiser<false>(src, kernel, dst, conv_flag, accu_flag, handle);
//        break;
//
//    default:
//        break;
...
//
//_DECX_API_ void
//decx::cuda::Filter2D_MC_MK_Raw_API(decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst,
//    const int conv_flag, const int accu_flag, const int output_type, de::DH* handle)
//{
//    if (!decx::cuda::_is_CUDA_init()) {
//        decx::err::CUDA_Not_init<false>(handle);
...
//    {
//    case decx::_DATA_TYPES_FLAGS_::_UINT8_:
//        decx::conv::filter2D_uc8_MK_organiser<false>(src, kernel, dst, conv_flag, output_type, handle);
//        break;
//
//    case decx::_DATA_TYPES_FLAGS_::_FP32_:
//        decx::conv::filter2D_fp32_MK_organiser<false>(src, kernel, dst, conv_flag, handle);
//        break;
//
//    case decx::_DATA_TYPES_FLAGS_::_FP16_:
//        decx::conv::filter2D_fp16_MK_organiser<false>(src, kernel, dst, conv_flag, accu_flag, handle);
//        break;
//
//    default:
//        break;
