    ...
    const int conv_flag, de::DH* handle)
{
    ...
    case decx::bp::extend_label::_EXTEND_CONSTANT_:
        dst->re_construct(decx::_DATA_TYPES_FLAGS_::_FP32_, src->Width(), src->Height(), src->MatrixNumber());
    ...
    const int conv_flag, const int _accu_flag, de::DH* handle)
{
    ...
    case decx::bp::extend_label::_EXTEND_CONSTANT_:
        dst->re_construct(decx::_DATA_TYPES_FLAGS_::_FP16_, src->Width(), src->Height(), src->MatrixNumber());
