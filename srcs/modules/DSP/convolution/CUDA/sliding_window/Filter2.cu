...
namespace decx
{
    namespace conv
    {
        ...
        void Conv2_uint8(decx::_Matrix* src, decx::_Matrix* kernel, decx::_Matrix* dst, 
            const int flag, const int output_type, de::DH* handle);
    }
}
    ...
    const int flag, const int output_type,  de::DH* handle)
{
    ...
    case decx::bp::extend_label::_EXTEND_NONE_:
        _dst->re_construct(output_type, _src->Width() - _kernel->Width() + 1,
            _src->Height() - _kernel->Height() + 1, _src->get_store_type());
    ...
    case decx::bp::extend_label::_EXTEND_CONSTANT_:
        _dst->re_construct(output_type, _src->Width(), _src->Height(), _src->get_store_type());
...
//
//_DECX_API_ void 
//decx::cuda::Filter2D_Raw_API(decx::_Matrix* _src, decx::_Matrix* _kernel, decx::_Matrix* _dst,
...
//    {
//    case decx::_DATA_TYPES_FLAGS_::_FP32_:
//        decx::conv::Conv2_fp32<false>(_src, _kernel, _dst, conv_flag, handle);
//        break;
//
//    case decx::_DATA_TYPES_FLAGS_::_FP16_:
//        decx::conv::Conv2_fp16<false>(_src, _kernel, _dst, conv_flag, accu_flag, handle);
//        break;
//
//    case decx::_DATA_TYPES_FLAGS_::_UINT8_:
//        decx::conv::Conv2_uint8<false>(_src, _kernel, _dst, conv_flag, output_type, handle);
//        break;
//
//    default:
//        break;
