...
#ifndef _CONV2_BORDER_CONST_MC_UINT8_H_
#define _CONV2_BORDER_CONST_MC_UINT8_H_
...
namespace decx
{
    namespace conv {
        ...
        */
        ...
        static void conv2_uint8_BC_SK_pre_process(decx::conv::_CCAC_uint8* _ccac, de::DH* handle);


        template <bool _print, bool _is_MK>
        static void conv2_uc8_uc8_BC_SK(decx::conv::_CCAC_uint8* _ccac, de::DH* handle);


        template <bool _print, bool _is_MK>
        static void conv2_uc8_fp32_BC_SK(decx::conv::_CCAC_uint8* _ccac, de::DH* handle);
    }
}


template <bool _print, typename _src_type, typename _kernel_type, typename _dst_type>
static void decx::conv::conv2_uint8_BC_SK_pre_process(decx::conv::_CCAC_uint8* _ccac, de::DH* handle)
{
    // generate the params for buffers
    decx::conv::_cuda_conv2_uint8_BC_buf_dims_config(&_ccac->_Kparams);
...
decx::conv::conv2_uc8_uc8_BC_SK(decx::conv::_CCAC_uint8* _ccac, de::DH* handle)
{
    // generate every parameters convolution needs
    decx::conv::conv2_uint8_BC_SK_pre_process<_print, uint8_t, float, uint8_t>(_ccac, handle);
    ...
    for (int i = 0; i < _loop; ++i) 
    {
        ...
        decx::conv::conv2_uc8_kfp32_kernels_caller(read_ptr,
                                                   kernel_ptr,
                                                   write_ptr,
...
template <bool _print, bool _is_MK> static void 
decx::conv::conv2_uc8_fp32_BC_SK(decx::conv::_CCAC_uint8* _ccac, de::DH* handle)
{
    // generate every parameters convolution needs
    decx::conv::conv2_uint8_BC_SK_pre_process<_print, uint8_t, float, float>(_ccac, handle);
