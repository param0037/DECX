...
#ifndef _DEV_CONV2_BORDER_CONST_MC_UINT8_H_
#define _DEV_CONV2_BORDER_CONST_MC_UINT8_H_
...
namespace decx
{
    namespace conv {
        ...
        static void dev_conv2_uc8_uc8_BC_SK(decx::conv::_cuda_conv2_uc8_uc8_preset* _ccac, de::DH* handle);


        template <bool _print, bool _is_MK>
        static void dev_conv2_uc8_fp32_BC_SK(decx::conv::_cuda_conv2_uc8_uc8_preset* _ccac, de::DH* handle);
    }
}


template <bool _print, bool _is_MK> static void 
decx::conv::dev_conv2_uc8_uc8_BC_SK(decx::conv::_cuda_conv2_uc8_uc8_preset* _conv2_preset, de::DH* handle)
{
    // generate every parameters convolution needs
    decx::conv::_conv2_uint8_BC_pre_process<_print, uint8_t, true>(_conv2_preset, handle);
...
template <bool _print, bool _is_MK> static void 
decx::conv::dev_conv2_uc8_fp32_BC_SK(decx::conv::_cuda_conv2_uc8_uc8_preset* _conv2_preset, de::DH* handle)
{
    // generate every parameters convolution needs
