...
#ifndef _CONV2_BORDER_CONST_UINT8_H_
#define _CONV2_BORDER_CONST_UINT8_H_
...
namespace decx
{
    namespace conv 
    {
        ...
        static void _conv2_uint8_BC_pre_process(decx::conv::_cuda_conv2_uc8_uc8_preset* _conv2_preset, de::DH* handle);


        template<bool _print>
        static void conv2_uc8_uc8_BC(decx::conv::_cuda_conv2_uc8_uc8_preset* _conv2_preset, de::DH* handle);


        template<bool _print>
        static void conv2_uc8_fp32_BC(decx::conv::_cuda_conv2_uc8_uc8_preset* _conv2_preset, de::DH* handle);
    }
}
...
static void decx::conv::_conv2_uint8_BC_pre_process(decx::conv::_cuda_conv2_uc8_uc8_preset* _conv2_preset, de::DH* handle)
{
    decx::conv::_cuConv2_kernel_params* k_params = &_conv2_preset->_Kparams;

    decx::conv::_cuda_conv2_uint8_BC_buf_dims_config(k_params);
...
template<bool _print>
static void decx::conv::conv2_uc8_uc8_BC(decx::conv::_cuda_conv2_uc8_uc8_preset* _conv2_preset, de::DH* handle)
{
...
template<bool _print>
static void decx::conv::conv2_uc8_fp32_BC(decx::conv::_cuda_conv2_uc8_uc8_preset* _conv2_preset, de::DH* handle)
{
