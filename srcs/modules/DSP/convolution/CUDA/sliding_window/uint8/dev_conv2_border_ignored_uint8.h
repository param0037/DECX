...
#ifndef _DEV_CONV2_BORDER_IGNORED_UINT8_H_
#define _DEV_CONV2_BORDER_IGNORED_UINT8_H_
...
namespace decx
{
    namespace conv 
    {
        ...
        static void dev_conv2_uc8_uc8_NB(decx::conv::_cuda_conv2_uc8_uc8_preset* _conv2_preset, de::DH* handle);


        template<bool _print>
        static void dev_conv2_uc8_fp32_NB(decx::conv::_cuda_conv2_uc8_uc8_preset* _conv2_preset, de::DH* handle);
    }
}
...
template<bool _print>
static void decx::conv::dev_conv2_uc8_uc8_NB(decx::conv::_cuda_conv2_uc8_uc8_preset* _conv2_preset, de::DH* handle)
{
...
template<bool _print>
static void decx::conv::dev_conv2_uc8_fp32_NB(decx::conv::_cuda_conv2_uc8_uc8_preset* _conv2_preset, de::DH* handle)
{
