...
void decx::dsp::GPUK::cu_filter2D_NB_u8_fp32(const double* __restrict src, 
...
template __global__ void decx::dsp::GPUK::cu_filter2D_NB_u8_fp32<32>(const double* __restrict, const float* __restrict,
    float4* __restrict, const uint32_t, const uint32_t, const uint3, const uint2);

template __global__ void decx::dsp::GPUK::cu_filter2D_NB_u8_fp32<16>(const double* __restrict, const float* __restrict,
    float4* __restrict, const uint32_t, const uint32_t, const uint3, const uint2);



template <uint32_t _ext_w> __global__
void decx::dsp::GPUK::cu_filter2D_BC_u8_fp32(const double* __restrict src,
                                             const float* __restrict kernel, 
                                             float4* __restrict dst,
                                             const uint32_t pitchsrc_v8, 
                                             const uint32_t pitchdst_v8, 
...
template __global__ void decx::dsp::GPUK::cu_filter2D_BC_u8_fp32<32>(const double* __restrict, const float* __restrict,
    float4* __restrict, const uint32_t, const uint32_t, const uint3, const uint2);

template __global__ void decx::dsp::GPUK::cu_filter2D_BC_u8_fp32<16>(const double* __restrict, const float* __restrict,
    float4* __restrict, const uint32_t, const uint32_t, const uint3, const uint2);
