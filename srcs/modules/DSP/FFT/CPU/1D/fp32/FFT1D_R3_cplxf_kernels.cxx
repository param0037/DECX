                                                ...
                                                const uint32_t              signal_length)
{
    ...
    for (uint32_t i = 0; i < total_Bcalc_num; ++i) 
    {
        ...
        _mm256_store_pd(dst + (i * 12), res._vd);
        ...
        res._vf = _mm256_permutevar8x32_ps(res._vf, _mm256_setr_epi32(0, 4, 1, 5, 2, 6, 3, 7));
        _mm256_store_pd(dst + (i * 12) + 4, res._vd);
        ...
        _mm256_store_pd(dst + (i * 12) + 8, res._vd);
    }
}
...
_THREAD_CALL_ void
decx::dsp::fft::CPUK::_FFT1D_R3_cplxf32_1st_C2C(const double* __restrict     src, 
                                                double* __restrict           dst, 
                                                const uint32_t               signal_length)
{
...
decx::dsp::fft::CPUK::_FFT1D_R3_cplxf32_mid_C2C(const double* __restrict        src, 
                                                double* __restrict              dst, 
