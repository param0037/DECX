                                                   ...
                                                   de::DH* handle)
{
    ...
    for (int i = 0; i < exec_t1D.total_thread - 1; ++i) 
    {
        ...
        exec_t1D._async_thread[i] = decx::cpu::register_task_default( decx::signal::FFT2D_C2C_fp32_1D_caller<true>, packed_param_array + i);
    ...
    if (src->Height() % 4)
    {
        exec_t1D._async_thread[exec_t1D.total_thread - 1] = decx::cpu::register_task_default( decx::signal::FFT2D_C2C_fp32_1D_caller_L4<true>,
        ...
        exec_t1D._async_thread[exec_t1D.total_thread - 1] = decx::cpu::register_task_default( decx::signal::FFT2D_C2C_fp32_1D_caller<true>,
            packed_param_array + exec_t1D.total_thread - 1);
    }
