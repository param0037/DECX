...
namespace decx
{
    namespace signal
    {
        ...
        static void dev_CUDA_FFT1D_R5_C2C_last_caller(decx::alloc::MIF<de::CPf>* MIF_0, decx::alloc::MIF<de::CPf>* MIF_1, de::CPf* dst,
        ...
        static void dev_CUDA_IFFT1D_R5_C2R_last_caller(decx::alloc::MIF<de::CPf>* MIF_0, decx::alloc::MIF<de::CPf>* MIF_1, de::CPf* dst,
            const size_t signal_len, const uint warp_proc_len, decx::cuda_stream* S);
    }
}
...
static void
decx::signal::dev_CUDA_FFT1D_R5_C2C_last_caller(decx::alloc::MIF<de::CPf>* MIF_0, decx::alloc::MIF<de::CPf>* MIF_1, de::CPf* dst,
    const size_t signal_len, const uint warp_proc_len, decx::cuda_stream* S)
{
    if ((warp_proc_len / 5) % 4) {
        const size_t total_B_ops_num = signal_len / 5;
...
static void
decx::signal::dev_CUDA_IFFT1D_R5_C2R_last_caller(decx::alloc::MIF<de::CPf>* MIF_0, decx::alloc::MIF<de::CPf>* MIF_1, de::CPf *dst, 
    const size_t signal_len, const uint warp_proc_len, decx::cuda_stream* S)
{
    const size_t total_B_ops_num = signal_len / 5;
    ...
    // decx::signal::GPUK::cu_IFFT1D_R5_C2R_vec4_last not gonna be executed !
}
