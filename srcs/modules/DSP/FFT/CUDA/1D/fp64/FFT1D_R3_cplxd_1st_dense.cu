...
// [32 * 2, 8] = [64, 8]
__global__ void 
decx::dsp::fft::GPUK::cu_FFT2D_R3_1st_cplxd_R2C_dense(const double* __restrict src,
...
decx::dsp::fft::GPUK::cu_FFT2D_R3_1st_cplxd_C2C_dense(const double2* __restrict src,
                                               double2* __restrict dst,
                                               const uint32_t _signal_len,
...
template __global__ void decx::dsp::fft::GPUK::cu_FFT2D_R3_1st_cplxd_C2C_dense<true>(const double2* __restrict, double2* __restrict,
    const uint32_t, const uint32_t, const uint32_t, const uint64_t);

template __global__ void decx::dsp::fft::GPUK::cu_FFT2D_R3_1st_cplxd_C2C_dense<false>(const double2* __restrict, double2* __restrict,
    const uint32_t, const uint32_t, const uint32_t, const uint64_t);



template <bool _conj> __global__ void 
decx::dsp::fft::GPUK::cu_FFT2D_R3_end_cplxd_C2C_dense(const double2* __restrict src,
                                                      double2* __restrict dst,
...
template __global__ void decx::dsp::fft::GPUK::cu_FFT2D_R3_end_cplxd_C2C_dense<true>(const double2* __restrict, double2* __restrict,
    const decx::dsp::fft::FKI_4_2DK, const uint32_t, const uint32_t);

template __global__ void decx::dsp::fft::GPUK::cu_FFT2D_R3_end_cplxd_C2C_dense<false>(const double2* __restrict, double2* __restrict,
    const decx::dsp::fft::FKI_4_2DK, const uint32_t, const uint32_t);
...
__global__ void 
decx::dsp::fft::GPUK::cu_FFT2D_R3_end_cplxd_C2R_dense(const double2* __restrict src,
