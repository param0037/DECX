                                ...
                                const uint procH)
{
    ...
    size_t dex_base_src = dex_h * pitchsrc,
        dex_base_dst = dex_h * pitchdst;

    float4 recv[4];
    de::CPf res[4];

    if (dex_h < procH && dex_w < B_ops_num) {
        recv[0] = src[dex_base_src + dex_w];
        recv[1] = src[dex_base_src + dex_w + B_ops_num];
        recv[2] = src[dex_base_src + dex_w + B_ops_num * 2];
        recv[3] = src[dex_base_src + dex_w + B_ops_num * 3];
        ...
        dst[dex_base_dst + dex_w * 8] = *((float4*)&res[0]);
        dst[dex_base_dst + dex_w * 8 + 1] = *((float4*)&res[2]);
        ...
        dst[dex_base_dst + dex_w * 8 + 2] = *((float4*)&res[0]);
        dst[dex_base_dst + dex_w * 8 + 3] = *((float4*)&res[2]);
        ...
        dst[dex_base_dst + dex_w * 8 + 4] = *((float4*)&res[0]);
        dst[dex_base_dst + dex_w * 8 + 5] = *((float4*)&res[2]);
        ...
        dst[dex_base_dst + dex_w * 8 + 6] = *((float4*)&res[0]);
        dst[dex_base_dst + dex_w * 8 + 7] = *((float4*)&res[2]);
    }
}
