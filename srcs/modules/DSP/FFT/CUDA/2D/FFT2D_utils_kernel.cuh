    ...
    namespace signal {
        namespace utils {
            namespace gpu 
            {
                ...
                static void _dev_FFT2D_transpose_C2C_Async(decx::alloc::MIF<de::CPf>* MIF_0, de::CPf* dst,
                    const uint pitchsrc, const uint pitchdst, const uint2 proc_dim_dst, decx::cuda_stream* S);
                ...
                static void _dev_FFT2D_transpose_C2C_div_Async(decx::alloc::MIF<de::CPf>* MIF, de::CPf* dst,
                    const uint pitchsrc, const uint pitchdst, const uint2 proc_dim_dst, const uint signal_len, decx::cuda_stream* S);
                ...
                static void _dev_IFFT2D_transpose_R2R_Async(decx::alloc::MIF<de::CPf>* MIF, de::CPf* dst,
                    const uint pitchsrc, const uint pitchdst, const uint2 proc_dim_dst, decx::cuda_stream* S);
            }
        }
    }
...
static void 
decx::signal::utils::gpu::_dev_FFT2D_transpose_C2C_Async(decx::alloc::MIF<de::CPf>* MIF_0, de::CPf* dst,
    const uint pitchsrc, const uint pitchdst, const uint2 proc_dim_dst, decx::cuda_stream* S)
{
    dim3 transp_thread_0(_CUDA_TRANSPOSE_4X4_D_BLOCK_SIZE_, _CUDA_TRANSPOSE_4X4_D_BLOCK_SIZE_);
    dim3 transp_grid_0(decx::utils::ceil<uint>(proc_dim_dst.y, _CUDA_TRANSPOSE_4X4_D_BLOCK_SIZE_ * 4),
    ...
    double2* read_ptr = reinterpret_cast<double2*>(MIF_0->mem), 
        *write_ptr = reinterpret_cast<double2*>(dst);
...
static void
decx::signal::utils::gpu::_dev_FFT2D_transpose_C2C_div_Async(decx::alloc::MIF<de::CPf>* MIF, de::CPf* dst,
    const uint pitchsrc, const uint pitchdst, const uint2 proc_dim_dst, const uint signal_len, decx::cuda_stream* S)
{
    dim3 transp_thread_0(_CUDA_TRANSPOSE_4X4_D_BLOCK_SIZE_, _CUDA_TRANSPOSE_4X4_D_BLOCK_SIZE_);
    dim3 transp_grid_0(decx::utils::ceil<uint>(proc_dim_dst.y, _CUDA_TRANSPOSE_4X4_D_BLOCK_SIZE_ * 4),
    ...
    decx::bp::GPUK::cu_transpose_vec4x4d_and_divide << <transp_grid_0, transp_thread_0, 0, S->get_raw_stream_ref() >> > (
        reinterpret_cast<double2*>(MIF->mem), reinterpret_cast<double2*>(dst), pitchsrc, pitchdst, (float)signal_len, proc_dim_dst);
}
...
static void
decx::signal::utils::gpu::_dev_IFFT2D_transpose_R2R_Async(decx::alloc::MIF<de::CPf>* MIF, de::CPf* dst,
    const uint pitchsrc, const uint pitchdst, const uint2 proc_dim_dst, decx::cuda_stream* S)
{
    dim3 transp_thread_0(_CUDA_TRANSPOSE_4X4_D_BLOCK_SIZE_, _CUDA_TRANSPOSE_4X4_D_BLOCK_SIZE_);
    dim3 transp_grid_0(decx::utils::ceil<uint>(proc_dim_dst.x, _CUDA_TRANSPOSE_4X4_D_BLOCK_SIZE_ * 4),
    ...
    decx::bp::GPUK::cu_transpose_vec4x4 << <transp_grid_0, transp_thread_0, 0, S->get_raw_stream_ref() >> > (
        reinterpret_cast<float4*>(MIF->mem), reinterpret_cast<float4*>(dst), pitchsrc, pitchdst, make_uint2(proc_dim_dst.y, proc_dim_dst.x));
}
