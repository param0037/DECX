...
//#define One_Over_Two_Pi_SQRT 0.5641895835495
...
de::signal::cuda::Gaussian_Window1D(de::GPU_Vector& src, de::GPU_Vector& dst, const float u, const float sigma)
{
    ...
    decx::signal::GPUK::cu_Gaussian_Window1D_cpl32 << <decx::utils::ceil<size_t>(_proc_len_v2, decx::cuP.prop.maxThreadsPerBlock),
...
de::signal::cuda::Triangular_Window1D(de::GPU_Vector& src, de::GPU_Vector& dst, const long long origin, const size_t radius)
{
    ...
    const size_t _proc_len_v2 = _src->_length / 2;
    decx::signal::GPUK::cu_Triangluar_Window1D_cpl32 << <decx::utils::ceil<size_t>(_proc_len_v2, decx::cuP.prop.maxThreadsPerBlock),
        decx::cuP.prop.maxThreadsPerBlock, 0, S->get_raw_stream_ref() >> > (
