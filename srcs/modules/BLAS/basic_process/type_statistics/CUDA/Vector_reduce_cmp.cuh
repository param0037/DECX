...
namespace decx
{
    namespace reduce
    {
        ...
        static void vector_reduce_cmp_fp64(decx::_Vector* src, de::DecxNumber *res);


        template <bool _is_max>
        static void vector_reduce_cmp_fp32(decx::_Vector* src, de::DecxNumber* res);


        template <bool _is_max>
        static void vector_reduce_cmp_fp16(decx::_Vector* src, de::DecxNumber* res);


        template <bool _is_max>
        static void vector_reduce_cmp_u8(decx::_Vector* src, de::DecxNumber* res);


        template <bool _is_max>
        static void dev_vector_reduce_cmp_fp64(decx::_GPU_Vector* src, de::DecxNumber* res);


        template <bool _is_max>
        static void dev_vector_reduce_cmp_fp32(decx::_GPU_Vector* src, de::DecxNumber* res);


        template <bool _is_max>
        static void dev_vector_reduce_cmp_fp16(decx::_GPU_Vector* src, de::DecxNumber* res);


        template <bool _is_max>
        static void dev_vector_reduce_cmp_u8(decx::_GPU_Vector* src, de::DecxNumber* res);
    }
}


template <bool _is_max>
static void decx::reduce::vector_reduce_cmp_fp32(decx::_Vector* src, de::DecxNumber* res)
{
    ...
    checkCudaErrors(cudaMemcpyAsync(res->get_data_ptr(), _kp_configs.get_dst(), 1 * sizeof(float), cudaMemcpyDeviceToHost, S->get_raw_stream_ref()));
...
template <bool _is_max>
static void decx::reduce::vector_reduce_cmp_fp64(decx::_Vector* src, de::DecxNumber* res)
{
    decx::cuda_stream* S = NULL;
    S = decx::cuda::get_cuda_stream_ptr(cudaStreamNonBlocking);
    if (S == NULL) {
    ...
    checkCudaErrors(cudaMemcpyAsync(res->get_data_ptr(), _kp_configs.get_dst(), 1 * sizeof(double), cudaMemcpyDeviceToHost, S->get_raw_stream_ref()));
...
template <bool _is_max>
static void decx::reduce::vector_reduce_cmp_fp16(decx::_Vector* src, de::DecxNumber* res)
{
    decx::cuda_stream* S = NULL;
    S = decx::cuda::get_cuda_stream_ptr(cudaStreamNonBlocking);
    if (S == NULL) {
    ...
    checkCudaErrors(cudaMemcpyAsync(res->get_data_ptr(), _kp_configs.get_dst(), 1 * sizeof(de::Half), cudaMemcpyDeviceToHost, S->get_raw_stream_ref()));
...
template <bool _is_max>
static void decx::reduce::vector_reduce_cmp_u8(decx::_Vector* src, de::DecxNumber* res)
{
    decx::cuda_stream* S = NULL;
    S = decx::cuda::get_cuda_stream_ptr(cudaStreamNonBlocking);
    if (S == NULL) {
    ...
    checkCudaErrors(cudaMemcpyAsync(res->get_data_ptr(), _kp_configs.get_dst(), 1 * sizeof(uint8_t), cudaMemcpyDeviceToHost, S->get_raw_stream_ref()));
...
template <bool _is_max>
static void decx::reduce::dev_vector_reduce_cmp_fp64(decx::_GPU_Vector* src, de::DecxNumber* res)
{
    decx::cuda_stream* S = NULL;
    S = decx::cuda::get_cuda_stream_ptr(cudaStreamNonBlocking);
    if (S == NULL) {
...
template <bool _is_max>
static void decx::reduce::dev_vector_reduce_cmp_fp32(decx::_GPU_Vector* src, de::DecxNumber* res)
{
    decx::cuda_stream* S = NULL;
    S = decx::cuda::get_cuda_stream_ptr(cudaStreamNonBlocking);
    if (S == NULL) {
...
template <bool _is_max>
static void decx::reduce::dev_vector_reduce_cmp_fp16(decx::_GPU_Vector* src, de::DecxNumber* res)
{
    decx::cuda_stream* S = NULL;
    S = decx::cuda::get_cuda_stream_ptr(cudaStreamNonBlocking);
    if (S == NULL) {
...
template <bool _is_max>
static void decx::reduce::dev_vector_reduce_cmp_u8(decx::_GPU_Vector* src, de::DecxNumber* res)
{
    decx::cuda_stream* S = NULL;
    S = decx::cuda::get_cuda_stream_ptr(cudaStreamNonBlocking);
    if (S == NULL) {
