...
namespace decx
{
    namespace reduce
    {
        static void matrix_reduce2D_full_sum_fp32(decx::_Matrix* src, de::DecxNumber* res);
        static void dev_matrix_reduce2D_full_sum_fp32(decx::_GPU_Matrix* src, de::DecxNumber* res);

        static void matrix_reduce2D_full_sum_fp16(decx::_Matrix* src, de::DecxNumber* res, const uint32_t _fp16_accu);
        static void dev_matrix_reduce2D_full_sum_fp16(decx::_GPU_Matrix* src, de::DecxNumber* res, const uint32_t _fp16_accu);

        static void matrix_reduce2D_full_sum_u8_i32(decx::_Matrix* src, de::DecxNumber* res);
        static void dev_matrix_reduce2D_full_sum_u8_i32(decx::_GPU_Matrix* src, de::DecxNumber* res);

        static void matrix_reduce2D_full_sum_fp64(decx::_Matrix* src, de::DecxNumber* res);
        static void dev_matrix_reduce2D_full_sum_fp64(decx::_GPU_Matrix* src, de::DecxNumber* res);

        static void matrix_reduce2D_full_sum_i32(decx::_Matrix* src, de::DecxNumber* res);
        static void dev_matrix_reduce2D_full_sum_i32(decx::_GPU_Matrix* src, de::DecxNumber* res);
...
static void decx::reduce::matrix_reduce2D_full_sum_fp32(decx::_Matrix* src, de::DecxNumber* res)
{
    decx::cuda_stream* S = NULL;
    S = decx::cuda::get_cuda_stream_ptr(cudaStreamNonBlocking);
    if (S == NULL) {
...
static void decx::reduce::matrix_reduce2D_full_sum_fp16(decx::_Matrix* src, de::DecxNumber* res, const uint32_t _fp16_accu)
{
    decx::cuda_stream* S = NULL;
    S = decx::cuda::get_cuda_stream_ptr(cudaStreamNonBlocking);
    if (S == NULL) {
...
static void decx::reduce::matrix_reduce2D_full_sum_u8_i32(decx::_Matrix* src, de::DecxNumber* res)
{
    decx::cuda_stream* S = NULL;
    S = decx::cuda::get_cuda_stream_ptr(cudaStreamNonBlocking);
    if (S == NULL) {
...
static void decx::reduce::dev_matrix_reduce2D_full_sum_fp32(decx::_GPU_Matrix* src, de::DecxNumber* res)
{
    decx::cuda_stream* S = NULL;
    S = decx::cuda::get_cuda_stream_ptr(cudaStreamNonBlocking);
    if (S == NULL) {
...
static void decx::reduce::matrix_reduce2D_full_sum_fp64(decx::_Matrix* src, de::DecxNumber* res)
{
    decx::cuda_stream* S = NULL;
    S = decx::cuda::get_cuda_stream_ptr(cudaStreamNonBlocking);
    if (S == NULL) {
...
static void decx::reduce::dev_matrix_reduce2D_full_sum_fp16(decx::_GPU_Matrix* src, de::DecxNumber* res, const uint32_t _fp16_accu)
{
    decx::cuda_stream* S = NULL;
    S = decx::cuda::get_cuda_stream_ptr(cudaStreamNonBlocking);
    if (S == NULL) {
...
static void decx::reduce::matrix_reduce2D_full_sum_i32(decx::_Matrix* src, de::DecxNumber* res)
{
    decx::cuda_stream* S = NULL;
    S = decx::cuda::get_cuda_stream_ptr(cudaStreamNonBlocking);
    if (S == NULL) {
...
static void decx::reduce::dev_matrix_reduce2D_full_sum_u8_i32(decx::_GPU_Matrix* src, de::DecxNumber* res)
{
    decx::cuda_stream* S = NULL;
    S = decx::cuda::get_cuda_stream_ptr(cudaStreamNonBlocking);
    if (S == NULL) {
...
static void decx::reduce::dev_matrix_reduce2D_full_sum_fp64(decx::_GPU_Matrix* src, de::DecxNumber* res)
{
    decx::cuda_stream* S = NULL;
    S = decx::cuda::get_cuda_stream_ptr(cudaStreamNonBlocking);
    if (S == NULL) {
...
static void decx::reduce::dev_matrix_reduce2D_full_sum_i32(decx::_GPU_Matrix* src, de::DecxNumber* res)
{
    decx::cuda_stream* S = NULL;
    S = decx::cuda::get_cuda_stream_ptr(cudaStreamNonBlocking);
    if (S == NULL) {
