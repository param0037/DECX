    ...
    const uint32_t right, de::DH* handle)
{
    ...
    {
    case sizeof(double) :
        decx::bp::_extend_constant_b64_1D<_print>((double*)src->Vec.ptr, (double*)dst->Vec.ptr, *((double*)val),
            left, right, src->_length, src->length, handle);
        break;

    case sizeof(float):
        decx::bp::_extend_constant_b32_1D<_print>((float*)src->Vec.ptr, (float*)dst->Vec.ptr, *((float*)val),
            left, right, src->_length, src->length, handle);
        break;

    case sizeof(uint8_t):
        decx::bp::_extend_constant_b8_1D<_print>((uint8_t*)src->Vec.ptr, (uint8_t*)dst->Vec.ptr, *((uint8_t*)val),
            left, right, src->_length, src->length, handle);
        break;

    case sizeof(uint16_t) :
        decx::bp::_extend_constant_b16_1D<_print>((uint16_t*)src->Vec.ptr, (uint16_t*)dst->Vec.ptr, *((uint16_t*)val),
            left, right, src->_length, src->length, handle);
        break;
    default:
        break;
...
static void decx::bp::_extend2D_constant(decx::_Matrix* src, decx::_Matrix* dst, void* val, const uint4 _ext_param, de::DH* handle)
{
    ...
    {
    case sizeof(double) :
        decx::bp::_extend_constant_b64_2D<_print>((double*)src->Mat.ptr, (double*)dst->Mat.ptr, *((double*)val), _ext_param, src->Pitch(), dst->Pitch(),
            src->Width(), src->Height(), handle);
        break;

        case sizeof(float) :
        decx::bp::_extend_constant_b32_2D<_print>((float*)src->Mat.ptr, (float*)dst->Mat.ptr, *((float*)val), _ext_param, src->Pitch(), dst->Pitch(),
            src->Width(), src->Height(), handle);
        break;

    case sizeof(uint8_t) :
        decx::bp::_extend_constant_b8_2D<_print>((uint8_t*)src->Mat.ptr, (uint8_t*)dst->Mat.ptr, *((uint8_t*)val), _ext_param, src->Pitch(), dst->Pitch(),
            src->Width(), src->Height(), handle);
        break;

    case sizeof(uint16_t) :
        decx::bp::_extend_constant_b16_2D<_print>((uint16_t*)src->Mat.ptr, (uint16_t*)dst->Mat.ptr, *((uint16_t*)val), _ext_param, src->Pitch(), dst->Pitch(),
            src->Width(), src->Height(), handle);
        break;
    default:
        break;
