...
template <>
void decx::cpu_GEMM_general_config<float>::Run(decx::_Matrix* _A, decx::_Matrix* _B, decx::_Matrix* _dst)
{
    if (this->_L) {
        // rearrange matrix B
        decx::gemm::CPUK::arrange_MatB_fp32_caller((float*)_B->Mat.ptr,         
                                                    this->_arranged_B.ptr, 
                                                    _B->Pitch(), 
        ...
        decx::GEMM_AB_fp32_caller_8x((float*)_A->Mat.ptr,                                   this->_arranged_B.ptr, 
                                     (float*)_dst->Mat.ptr,                                 this->_extra_dst.ptr, 
        ...
        decx::gemm::CPUK::GEMM_fp32_cpy_L8(this->_extra_dst.ptr,        start_dst, 
        ...
        // rearrange matrix B
        decx::gemm::CPUK::arrange_MatB_fp32_caller((float*)_B->Mat.ptr,         this->_arranged_B.ptr, 
                                                    _B->Pitch(),                this->_arranged_B_dims.x, 
                                                    _B->Height(),               false, 
                                                    &this->_t2D,                &this->_f_mgr_sort_B);

        // execute the GEMM_fp32 kernels
        decx::GEMM_AB_fp32_caller_16x((float*)_A->Mat.ptr,              this->_arranged_B.ptr, 
...
template <> 
void decx::cpu_GEMM_general_config<float>::release_buffers(decx::cpu_GEMM_general_config<float>* _fake_this)
{
