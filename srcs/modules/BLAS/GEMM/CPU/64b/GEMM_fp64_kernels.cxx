...
template void decx::blas::GEMM_64b_caller<true>(const double*, const double*, double*, const decx::_matrix_layout*,
...
template void decx::blas::GEMM_64b_caller<false>(const double*, const double*, double*, const decx::_matrix_layout*,
    const decx::_matrix_layout*, const uint2, const decx::utils::frag_manager*,
    const decx::blas::GEMM_blocking_config*, decx::utils::_thr_2D*, const double*);
