...
namespace decx
{
    namespace reduce
    {
        ...
        static void matrix_reduce2D_full_cmp_fp32(decx::_Matrix* src, de::Number* res);
        template <bool _is_max>
        static void dev_matrix_reduce2D_full_cmp_fp32(decx::_GPU_Matrix* src, de::Number* res);

        template <bool _is_max>
        static void matrix_reduce2D_full_cmp_int32(decx::_Matrix* src, de::Number* res);
        template <bool _is_max>
        static void dev_matrix_reduce2D_full_cmp_int32(decx::_GPU_Matrix* src, de::Number* res);

        template <bool _is_max>
        static void matrix_reduce2D_full_cmp_fp16(decx::_Matrix* src, de::Number* res);
        template <bool _is_max>
        static void dev_matrix_reduce2D_full_cmp_fp16(decx::_GPU_Matrix* src, de::Number* res);

        template <bool _is_max>
        static void matrix_reduce2D_full_cmp_u8(decx::_Matrix* src, de::Number* res);
        template <bool _is_max>
        static void dev_matrix_reduce2D_full_cmp_u8(decx::_GPU_Matrix* src, de::Number* res);

        template <bool _is_max>
        static void matrix_reduce2D_full_cmp_fp64(decx::_Matrix* src, de::Number* res);
        template <bool _is_max>
        static void dev_matrix_reduce2D_full_cmp_fp64(decx::_GPU_Matrix* src, de::Number* res);
...
static void decx::reduce::matrix_reduce2D_1way_cmp_fp32(decx::_Matrix* src, decx::_Vector* dst)
{
    ...
    checkCudaErrors(cudaMemcpyAsync((void*)dst->Vec, _configs.get_dst(), dst->Len() * sizeof(float), cudaMemcpyDeviceToHost, S->get_raw_stream_ref()));
...
static void decx::reduce::matrix_reduce2D_1way_cmp_fp16(decx::_Matrix* src, decx::_Vector* dst)
{
    ...
    checkCudaErrors(cudaMemcpyAsync((void*)dst->Vec, _configs.get_dst(), dst->Len() * sizeof(de::Half), cudaMemcpyDeviceToHost, S->get_raw_stream_ref()));
...
static void decx::reduce::matrix_reduce2D_1way_cmp_u8(decx::_Matrix* src, decx::_Vector* dst)
{
    ...
    checkCudaErrors(cudaMemcpyAsync((void*)dst->Vec, _configs.get_dst(), dst->Len() * sizeof(uint8_t), cudaMemcpyDeviceToHost, S->get_raw_stream_ref()));
...
template <bool _is_max>
static void decx::reduce::matrix_reduce2D_full_cmp_fp32(decx::_Matrix* src, de::Number* res)
{
    decx::cuda_stream* S = NULL;
    S = decx::cuda::get_cuda_stream_ptr(cudaStreamNonBlocking);
    if (S == NULL) {
...
template <bool _is_max>
static void decx::reduce::matrix_reduce2D_full_cmp_int32(decx::_Matrix* src, de::Number* res)
{
    decx::cuda_stream* S = NULL;
    S = decx::cuda::get_cuda_stream_ptr(cudaStreamNonBlocking);
    if (S == NULL) {
    ...
    // set the filling value
    _kp_configs.set_fill_val(((int32_t*)src->Mat)[0]);
...
template <bool _is_max>
static void decx::reduce::matrix_reduce2D_full_cmp_fp16(decx::_Matrix* src, de::Number* res)
{
    decx::cuda_stream* S = NULL;
    S = decx::cuda::get_cuda_stream_ptr(cudaStreamNonBlocking);
    if (S == NULL) {
    ...
    // set the filling value
    _kp_configs.set_fill_val(((de::Half*)src->Mat)[0]);
...
template <bool _is_max>
static void decx::reduce::matrix_reduce2D_full_cmp_u8(decx::_Matrix* src, de::Number* res)
{
    decx::cuda_stream* S = NULL;
    S = decx::cuda::get_cuda_stream_ptr(cudaStreamNonBlocking);
    if (S == NULL) {
...
template <bool _is_max>
static void decx::reduce::matrix_reduce2D_full_cmp_fp64(decx::_Matrix* src, de::Number* res)
{
    decx::cuda_stream* S = NULL;
    S = decx::cuda::get_cuda_stream_ptr(cudaStreamNonBlocking);
    if (S == NULL) {
...
template <bool _is_max>
static void decx::reduce::dev_matrix_reduce2D_full_cmp_fp32(decx::_GPU_Matrix* src, de::Number* res)
{
    decx::cuda_stream* S = NULL;
    S = decx::cuda::get_cuda_stream_ptr(cudaStreamNonBlocking);
    if (S == NULL) {
...
template <bool _is_max>
static void decx::reduce::dev_matrix_reduce2D_full_cmp_int32(decx::_GPU_Matrix* src, de::Number* res)
{
    decx::cuda_stream* S = NULL;
    S = decx::cuda::get_cuda_stream_ptr(cudaStreamNonBlocking);
    if (S == NULL) {
...
template <bool _is_max>
static void decx::reduce::dev_matrix_reduce2D_full_cmp_fp16(decx::_GPU_Matrix* src, de::Number* res)
{
    decx::cuda_stream* S = NULL;
    S = decx::cuda::get_cuda_stream_ptr(cudaStreamNonBlocking);
    if (S == NULL) {
...
template <bool _is_max>
static void decx::reduce::dev_matrix_reduce2D_full_cmp_u8(decx::_GPU_Matrix* src, de::Number* res)
{
    decx::cuda_stream* S = NULL;
    S = decx::cuda::get_cuda_stream_ptr(cudaStreamNonBlocking);
    if (S == NULL) {
...
template <bool _is_max>
static void decx::reduce::dev_matrix_reduce2D_full_cmp_fp64(decx::_GPU_Matrix* src, de::Number* res)
{
    decx::cuda_stream* S = NULL;
    S = decx::cuda::get_cuda_stream_ptr(cudaStreamNonBlocking);
    if (S == NULL) {
