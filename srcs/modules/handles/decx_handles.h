...
//#define FFT_ERROR_WIDTH                             "error: Width should be able to be separated by 2, 3 and 5\n"
//#define FFT_ERROR_HEIGHT                            "error: Height should be able to be separated by 2, 3 and 5\n"
