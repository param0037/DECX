...
template void decx::reduce::cuda_reduce1D_configs<float>::generate_configs<true>(const uint64_t proc_len_v1, decx::cuda_stream* S, de::DH* handle);
template void decx::reduce::cuda_reduce1D_configs<float>::generate_configs<false>(const uint64_t proc_len_v1, decx::cuda_stream* S, de::DH* handle);

template void decx::reduce::cuda_reduce1D_configs<uint8_t>::generate_configs<true>(const uint64_t proc_len_v1, decx::cuda_stream* S, de::DH* handle);
template void decx::reduce::cuda_reduce1D_configs<uint8_t>::generate_configs<false>(const uint64_t proc_len_v1, decx::cuda_stream* S, de::DH* handle);

template void decx::reduce::cuda_reduce1D_configs<de::Half>::generate_configs<true>(const uint64_t proc_len_v1, decx::cuda_stream* S, de::DH* handle);
template void decx::reduce::cuda_reduce1D_configs<de::Half>::generate_configs<false>(const uint64_t proc_len_v1, decx::cuda_stream* S, de::DH* handle);



template <typename _type_in>
template <bool _print>
void decx::reduce::cuda_reduce1D_configs<_type_in>::generate_configs(decx::PtrInfo<void> dev_src, const uint64_t proc_len_v1, decx::cuda_stream* S, de::DH* handle)
{
    this->_actual_len = proc_len_v1;
    uint64_t _first_grid_len = 0;
...
template void decx::reduce::cuda_reduce1D_configs<float>::generate_configs<true>(decx::PtrInfo<void> dev_src, const uint64_t proc_len_v1, 
    decx::cuda_stream* S, de::DH* handle);
template void decx::reduce::cuda_reduce1D_configs<float>::generate_configs<false>(decx::PtrInfo<void> dev_src, const uint64_t proc_len_v1, 
    decx::cuda_stream* S, de::DH* handle);

template void decx::reduce::cuda_reduce1D_configs<uint8_t>::generate_configs<true>(decx::PtrInfo<void> dev_src, const uint64_t proc_len_v1,
    decx::cuda_stream* S, de::DH* handle);
template void decx::reduce::cuda_reduce1D_configs<uint8_t>::generate_configs<false>(decx::PtrInfo<void> dev_src, const uint64_t proc_len_v1,
    decx::cuda_stream* S, de::DH* handle);

template void decx::reduce::cuda_reduce1D_configs<de::Half>::generate_configs<true>(decx::PtrInfo<void> dev_src, const uint64_t proc_len_v1,
    decx::cuda_stream* S, de::DH* handle);
template void decx::reduce::cuda_reduce1D_configs<de::Half>::generate_configs<false>(decx::PtrInfo<void> dev_src, const uint64_t proc_len_v1,
    decx::cuda_stream* S, de::DH* handle);
