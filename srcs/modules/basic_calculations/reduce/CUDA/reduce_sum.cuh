...
namespace decx
{
    namespace reduce
    {
        namespace GPUK 
        {
            ...
            * transposing the results, then store them in destinated buffer
            */
            void cu_warp_reduce_sum2D_h_fp16_fp32(const float4* __restrict src, float* __restrict dst,
            ...
            * process area[32 * 4, 8] = [128, 8]
            */
            void cu_warp_reduce_sum2D_v_fp16_fp32(const float4* __restrict src, float4* __restrict dst,
...
namespace decx
{
    namespace reduce {
        namespace GPUK {
            ...
            * transposing the results, then store them in destinated buffer
            */
            void cu_warp_reduce_sum2D_flatten_fp16_fp32(const float4* __restrict src, float* __restrict dst,
