        ...
        namespace CPUK {
            ...
            */
            _THREAD_FUNCTION_ void
                mul_m_fvec8_ST(const float* A, float* B, float* dst, size_t len);


            _THREAD_FUNCTION_ void
                mul_m_ivec8_ST(const __m256i* A, __m256i* B, __m256i* dst, size_t len);


            _THREAD_FUNCTION_ void
                mul_m_dvec4_ST(const double* A, double* B, double* dst, size_t len);
            ...
            _THREAD_FUNCTION_ void
                mul_c_ivec8_ST(const __m256i* src, const int __x, __m256i* dst, size_t len);
