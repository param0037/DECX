...
_DECX_API_ de::DH de::cpu::Add(de::Matrix& src, void* __x, de::Matrix& dst)
{
    ...
    case de::_DATA_TYPES_FLAGS_::_FP64_:
        ...
        decx::calc::operators_caller_c<decx::calc::_fp64_binary_ops_c, double, 4>(decx::calc::CPUK::add_c_dvec4_ST,
    ...
    case de::_DATA_TYPES_FLAGS_::_COMPLEX_F32_:
        ...
        decx::calc::operators_caller_c<decx::calc::_fp64_binary_ops_c, double, 4>(decx::calc::CPUK::cp_add_c_fvec4_ST,
            (double*)_src->Mat.ptr, *((double*)__x), (double*)_dst->Mat.ptr, t1D, &f_mgr);
        break;
    default:
        break;
