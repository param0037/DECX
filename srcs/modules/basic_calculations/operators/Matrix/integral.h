...
namespace decx
{
    namespace calc {
        ...
        void _integral_caller2D_fp32(const float* src, float* dst, const uint2 proc_dims,
            const uint pitchsrc, const uint pitchdst);


        void _integral_caller2D_uint8(const uint8_t* src, int32_t* dst, const uint2 proc_dims,
            const uint pitchsrc, const uint pitchdst);


        void _integral_caller2D_uint8_f32(const uint8_t* src, float* dst, const uint2 proc_dims,
            const uint pitchsrc, const uint pitchdst);
    }
}
