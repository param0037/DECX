...
_DECX_API_ de::DH de::cpu::Add(de::Matrix& A, de::Matrix& B, de::Matrix& dst)
{
    de::DH handle;
    if (!decx::cpI.is_init) {
    ...
    case decx::_DATA_TYPES_FLAGS_::_COMPLEX_F32_:
        ...
        decx::calc::operators_caller_m_fp64(decx::calc::CPUK::cp_add_m_fvec4_ST,
            (double*)_A->Mat.ptr, (double*)_B->Mat.ptr, (double*)_dst->Mat.ptr, t1D, &f_mgr);
        break;
...
_DECX_API_ de::DH de::cpu::Add(de::Matrix& src, void* __x, de::Matrix& dst)
{
    de::DH handle;
    if (!decx::cpI.is_init) {
        Print_Error_Message(4, CPU_NOT_INIT);
    ...
    case decx::_DATA_TYPES_FLAGS_::_COMPLEX_F32_:
        ...
        t1D = new decx::utils::_thread_arrange_1D(decx::cpI.cpu_concurrency);
        decx::utils::frag_manager_gen(&f_mgr, _src->_element_num / 4, t1D->total_thread);
        decx::calc::operators_caller_c_fp64(decx::calc::CPUK::cp_add_c_fvec4_ST,
            (double*)_src->Mat.ptr, *((double*)__x), (double*)_dst->Mat.ptr, t1D, &f_mgr);
        break;
    default:
        break;
