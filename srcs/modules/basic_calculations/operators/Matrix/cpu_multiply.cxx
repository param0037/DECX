...
_DECX_API_ de::DH de::cpu::Mul(de::Matrix& A, de::Matrix& B, de::Matrix& dst)
{
    ...
    case decx::_DATA_TYPES_FLAGS_::_FP32_:
        ...
        decx::calc::operators_caller_m_fp32(decx::calc::CPUK::mul_m_fvec8_ST,
    ...
    case decx::_DATA_TYPES_FLAGS_::_INT32_:
        ...
        decx::calc::operators_caller_m_int32(decx::calc::CPUK::mul_m_ivec8_ST,
    ...
    case decx::_DATA_TYPES_FLAGS_::_FP64_:
        ...
        decx::calc::operators_caller_m_fp64(decx::calc::CPUK::mul_m_dvec4_ST,
...
_DECX_API_ de::DH de::cpu::Mul(de::Matrix& src, void* __x, de::Matrix& dst)
{
    ...
    case decx::_DATA_TYPES_FLAGS_::_FP32_:
        ...
        decx::calc::operators_caller_c_fp32(decx::calc::CPUK::mul_c_fvec8_ST,
    ...
    case decx::_DATA_TYPES_FLAGS_::_INT32_:
        ...
        t1D = new decx::utils::_thread_arrange_1D(decx::cpI.cpu_concurrency);
        decx::utils::frag_manager_gen(&f_mgr, _src->_element_num / 8, t1D->total_thread);
        decx::calc::operators_caller_c_int32(decx::calc::CPUK::mul_c_ivec8_ST,
    ...
    case decx::_DATA_TYPES_FLAGS_::_FP64_:
        ...
        decx::calc::operators_caller_c_fp64(decx::calc::CPUK::mul_c_dvec4_ST,
