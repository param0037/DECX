...
_DECX_API_ de::DH de::cpu::Div(de::Matrix& A, de::Matrix& B, de::Matrix& dst)
{
    ...
    case decx::_DATA_TYPES_FLAGS_::_FP32_:
        ...
        decx::calc::operators_caller_m_fp32(decx::calc::CPUK::div_m_fvec8_ST,
    ...
    case decx::_DATA_TYPES_FLAGS_::_INT32_:
        ...
        // configure the process domain for each thread
        decx::utils::frag_manager_gen(&f_mgr, _A->_element_num / 8, t1D->total_thread);
        decx::calc::operators_caller_m_int32(decx::calc::CPUK::div_m_ivec8_ST,
    ...
    case decx::_DATA_TYPES_FLAGS_::_FP64_:
        ...
        decx::calc::operators_caller_m_fp64(decx::calc::CPUK::div_m_dvec4_ST,
...
_DECX_API_ de::DH de::cpu::Div(de::Matrix& src, void* __x, de::Matrix& dst)
{
    ...
    case decx::_DATA_TYPES_FLAGS_::_FP32_:
        // configure the process domain for each thread
        t1D = new decx::utils::_thread_arrange_1D(decx::cpI.cpu_concurrency);
        decx::utils::frag_manager_gen(&f_mgr, _src->_element_num / 8, t1D->total_thread);
        decx::calc::operators_caller_c_fp32(decx::calc::CPUK::div_c_fvec8_ST,
    ...
    case decx::_DATA_TYPES_FLAGS_::_INT32_:
        ...
        t1D = new decx::utils::_thread_arrange_1D(decx::cpI.cpu_concurrency);
        decx::utils::frag_manager_gen(&f_mgr, _src->_element_num / 8, t1D->total_thread);
        decx::calc::operators_caller_c_int32(decx::calc::CPUK::div_c_ivec8_ST,
    ...
    case decx::_DATA_TYPES_FLAGS_::_FP64_:
        // configure the process domain for each thread
        t1D = new decx::utils::_thread_arrange_1D(decx::cpI.cpu_concurrency);
        decx::utils::frag_manager_gen(&f_mgr, _src->_element_num / 4, t1D->total_thread);
        decx::calc::operators_caller_c_fp64(decx::calc::CPUK::div_c_dvec4_ST,
...
_DECX_API_ de::DH de::cpu::Div(void* __x, de::Matrix& src, de::Matrix& dst)
{
    ...
    case decx::_DATA_TYPES_FLAGS_::_FP32_:
        ...
        t1D = new decx::utils::_thread_arrange_1D(decx::cpI.cpu_concurrency);
        decx::utils::frag_manager_gen(&f_mgr, _src->_element_num / 8, t1D->total_thread);
        decx::calc::operators_caller_c_fp32(decx::calc::CPUK::div_cinv_fvec8_ST,
            (float*)_src->Mat.ptr, *((float*)__x), (float*)_dst->Mat.ptr, t1D, &f_mgr);
        break;
    ...
    case decx::_DATA_TYPES_FLAGS_::_INT32_:
        ...
        t1D = new decx::utils::_thread_arrange_1D(decx::cpI.cpu_concurrency);
        decx::utils::frag_manager_gen(&f_mgr, _src->_element_num / 8, t1D->total_thread);
        decx::calc::operators_caller_c_int32(decx::calc::CPUK::div_cinv_ivec8_ST,
            (int*)_src->Mat.ptr, *((int*)__x), (int*)_dst->Mat.ptr, t1D, &f_mgr);
        break;
    ...
    case decx::_DATA_TYPES_FLAGS_::_FP64_:
        ...
        t1D = new decx::utils::_thread_arrange_1D(decx::cpI.cpu_concurrency);
        decx::utils::frag_manager_gen(&f_mgr, _src->_element_num / 4, t1D->total_thread);
        decx::calc::operators_caller_c_fp64(decx::calc::CPUK::div_cinv_dvec4_ST,
            (double*)_src->Mat.ptr, *((double*)__x), (double*)_dst->Mat.ptr, t1D, &f_mgr);
        break;
    default:
        break;
