        ...
        namespace CPUK {
            ...
            */
            _THREAD_FUNCTION_ void
                cp_add_m_fvec4_ST(const double* A, const double* B, double* dst, size_t len);
            

            _THREAD_FUNCTION_ void
                cp_sub_m_fvec4_ST(const double* A, const double* B, double* dst, size_t len);



            _THREAD_FUNCTION_ void
                cp_mul_m_fvec4_ST(const double* A, const double* B, double* dst, size_t len);
