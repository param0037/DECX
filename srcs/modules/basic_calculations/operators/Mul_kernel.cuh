...
namespace decx
{
    namespace calc {
        static void dev_Kmul_m(float* DA, float* DB, float* Ddst, const size_t len) {
            ...
            decx::calc::GPUK::mul_m_fvec4 << <decx::utils::ceil<size_t>(len / 4, decx::cuP.prop.maxThreadsPerBlock), decx::cuP.prop.maxThreadsPerBlock >> > (
        ...
        static void dev_Kmul_m_2D(float* DA, float* DB, float* Ddst, const size_t eq_pitch, const uint2 bounds) {
            ...
            decx::calc::GPUK::mul_m_fvec4_2D << <grid, block >> > (_DAptr, _DBptr, _Ddstptr, eq_pitch / 4, bounds);
        }
        ...
        static void dev_Kmul_m(int* DA, int* DB, int* Ddst, const size_t len) {
            ...
            decx::calc::GPUK::mul_m_ivec4 << <decx::utils::ceil<size_t>(len / 4, decx::cuP.prop.maxThreadsPerBlock), decx::cuP.prop.maxThreadsPerBlock >> > (
                _DAptr, _DBptr, _Ddstptr, len / 4);
        }
        ...
        static void dev_Kmul_m_2D(int* DA, int* DB, int* Ddst, const size_t eq_pitch, const uint2 bounds) {
            ...
            decx::calc::GPUK::mul_m_ivec4_2D << <grid, block >> > (_DAptr, _DBptr, _Ddstptr, eq_pitch / 4, bounds);
        }
        ...
        static void dev_Kmul_m(de::Half* DA, de::Half* DB, de::Half* Ddst, const size_t len) {
            ...
            decx::calc::GPUK::mul_m_hvec8 << <decx::utils::ceil<size_t>(len / 8, decx::cuP.prop.maxThreadsPerBlock), decx::cuP.prop.maxThreadsPerBlock >> > (
        ...
        static void dev_Kmul_m_2D(de::Half* DA, de::Half* DB, de::Half* Ddst, const size_t eq_pitch, const uint2 bounds) {
            ...
            decx::calc::GPUK::mul_m_hvec8_2D << <grid, block >> > (_DAptr, _DBptr, _Ddstptr, eq_pitch / 8, bounds);
        }
        ...
        static void dev_Kmul_m(double* DA, double* DB, double* Ddst, const size_t len) {
            ...
            decx::calc::GPUK::mul_m_dvec2 << <decx::utils::ceil<size_t>(len / 2, decx::cuP.prop.maxThreadsPerBlock), decx::cuP.prop.maxThreadsPerBlock >> > (
        ...
        static void dev_Kmul_m_2D(double* DA, double* DB, double* Ddst, const size_t eq_pitch, const uint2 bounds) {
            ...
            decx::calc::GPUK::mul_m_dvec2_2D << <grid, block >> > (_DAptr, _DBptr, _Ddstptr, eq_pitch / 2, bounds);
        }
        ...
        static void dev_Kmul_c(float* Dsrc, float __x, float* Ddst, const size_t len) {
            ...
            decx::calc::GPUK::mul_c_fvec4 << <decx::utils::ceil<size_t>(len / 4, decx::cuP.prop.maxThreadsPerBlock), decx::cuP.prop.maxThreadsPerBlock >> > (
        ...
        static void dev_Kmul_c_2D(float* Dsrc, float __x, float* Ddst, const size_t eq_pitch, const uint2 bounds) {
            ...
            decx::calc::GPUK::mul_c_fvec4_2D << <grid, block >> > (_Dsrcptr, __x, _Ddstptr, eq_pitch / 4, bounds);
        }
        ...
        static void dev_Kmul_c(int* Dsrc, int __x, int* Ddst, const size_t len) {
            ...
            decx::calc::GPUK::mul_c_ivec4 << <decx::utils::ceil<size_t>(len / 4, decx::cuP.prop.maxThreadsPerBlock), decx::cuP.prop.maxThreadsPerBlock >> > (
                _Dsrcptr, __x, _Ddstptr, len / 4);
        }
        ...
        static void dev_Kmul_c_2D(int* Dsrc, int __x, int* Ddst, const size_t eq_pitch, const uint2 bounds) {
            ...
            decx::calc::GPUK::mul_c_ivec4_2D << <grid, block >> > (_Dsrcptr, __x, _Ddstptr, eq_pitch / 4, bounds);
        }
        ...
        static void dev_Kmul_c(de::Half* Dsrc, de::Half __x, de::Half* Ddst, const size_t len) {
            ...
            decx::calc::GPUK::mul_c_hvec8 << <decx::utils::ceil<size_t>(len / 8, decx::cuP.prop.maxThreadsPerBlock), decx::cuP.prop.maxThreadsPerBlock >> > (
        ...
        static void dev_Kmul_c(double* Dsrc, double __x, double* Ddst, const size_t len) {
            ...
            decx::calc::GPUK::mul_c_dvec2 << <decx::utils::ceil<size_t>(len / 2, decx::cuP.prop.maxThreadsPerBlock), decx::cuP.prop.maxThreadsPerBlock >> > (
        ...
        static void dev_Kmul_c_2D(double* Dsrc, double __x, double* Ddst, const size_t eq_pitch, const uint2 bounds) {
            ...
            decx::calc::GPUK::mul_c_dvec2_2D << <grid, block >> > (_Dsrcptr, __x, _Ddstptr, eq_pitch / 2, bounds);
        }
    }
}
