...
de::DH de::cuda::Div(de::GPU_Vector& A, de::GPU_Vector& B, de::GPU_Vector& dst)
{
    ...
    case decx::_DATA_TYPES_FLAGS_::_FP16_:
        decx::calc::dev_Kdiv_m((de::Half*)_A.Vec.ptr, (de::Half*)_B.Vec.ptr, (de::Half*)_dst.Vec.ptr, len, S);
        break;

    case decx::_DATA_TYPES_FLAGS_::_FP32_:
        decx::calc::dev_Kdiv_m((float*)_A.Vec.ptr, (float*)_B.Vec.ptr, (float*)_dst.Vec.ptr, len, S);
        break;

    case decx::_DATA_TYPES_FLAGS_::_INT32_:
        decx::calc::dev_Kdiv_m((int*)_A.Vec.ptr, (int*)_B.Vec.ptr, (int*)_dst.Vec.ptr, len, S);
        break;

    case decx::_DATA_TYPES_FLAGS_::_FP64_:
        decx::calc::dev_Kdiv_m((double*)_A.Vec.ptr, (double*)_B.Vec.ptr, (double*)_dst.Vec.ptr, len, S);
        break;
    default:
        break;
    }
...
de::DH de::cuda::Div(de::GPU_Vector& src, void* __x, de::GPU_Vector& dst)
{
    ...
    {
    case decx::_DATA_TYPES_FLAGS_::_FP16_:
        decx::calc::dev_Kdiv_c((de::Half*)_src.Vec.ptr, *((de::Half*)__x), (de::Half*)_dst.Vec.ptr, len, S);
        break;

    case decx::_DATA_TYPES_FLAGS_::_FP32_:
        decx::calc::dev_Kdiv_c((float*)_src.Vec.ptr, *((float*)__x), (float*)_dst.Vec.ptr, len, S);
        break;

    case decx::_DATA_TYPES_FLAGS_::_INT32_:
        decx::calc::dev_Kdiv_c((int*)_src.Vec.ptr, *((int*)__x), (int*)_dst.Vec.ptr, len, S);
        break;

    case decx::_DATA_TYPES_FLAGS_::_FP64_:
        decx::calc::dev_Kdiv_c((double*)_src.Vec.ptr, *((double*)__x), (double*)_dst.Vec.ptr, len, S);
        break;
    default:
        break;
    }
...
de::DH de::cuda::Div(void* __x, de::GPU_Vector& src, de::GPU_Vector& dst)
{
    ...
    {
    case decx::_DATA_TYPES_FLAGS_::_FP16_:
        decx::calc::dev_Kdiv_cinv(*((de::Half*)__x), (de::Half*)_src.Vec.ptr, (de::Half*)_dst.Vec.ptr, len, S);
        break;

    case decx::_DATA_TYPES_FLAGS_::_FP32_:
        decx::calc::dev_Kdiv_cinv(*((float*)__x), (float*)_src.Vec.ptr, (float*)_dst.Vec.ptr, len, S);
        break;

    case decx::_DATA_TYPES_FLAGS_::_INT32_:
        decx::calc::dev_Kdiv_cinv(*((int*)__x), (int*)_src.Vec.ptr, (int*)_dst.Vec.ptr, len, S);
        break;

    case decx::_DATA_TYPES_FLAGS_::_FP64_:
        decx::calc::dev_Kdiv_cinv(*((double*)__x), (double*)_src.Vec.ptr, (double*)_dst.Vec.ptr, len, S);
        break;
    default:
        break;
    }
