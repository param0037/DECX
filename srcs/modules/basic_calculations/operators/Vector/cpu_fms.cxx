...
_DECX_API_ de::DH de::cpu::Fms(de::Vector& A, de::Vector& B, de::Vector& C, de::Vector& dst)
{
    ...
    case decx::_DATA_TYPES_FLAGS_::_FP32_:
        ...
        decx::calc::operators_caller_m_fp32(decx::calc::CPUK::fms_m_fvec8_ST,
    ...
    case decx::_DATA_TYPES_FLAGS_::_INT32_:
        ...
        // configure the process domain for each thread
        decx::utils::frag_manager_gen(&f_mgr, _A->_length / 8, t1D->total_thread);
        decx::calc::operators_caller_m_int32(decx::calc::CPUK::fms_m_ivec8_ST,
    ...
    case decx::_DATA_TYPES_FLAGS_::_FP64_:
        ...
        decx::calc::operators_caller_m_fp64(decx::calc::CPUK::fms_m_dvec4_ST,
...
_DECX_API_ de::DH de::cpu::Fms(de::Vector& A, void* __x, de::Vector& B, de::Vector& dst)
{
    ...
    case decx::_DATA_TYPES_FLAGS_::_FP32_:
        ...
        // configure the process domain for each thread
        decx::utils::frag_manager_gen(&f_mgr, _A->_length / 8, t1D->total_thread);
        decx::calc::operators_caller_c_fp32(decx::calc::CPUK::fms_c_fvec8_ST,
    ...
    case decx::_DATA_TYPES_FLAGS_::_INT32_:
        ...
        // configure the process domain for each thread
        decx::utils::frag_manager_gen(&f_mgr, _A->_length / 8, t1D->total_thread);
        decx::calc::operators_caller_c_int32(decx::calc::CPUK::fms_c_ivec8_ST,
    ...
    case decx::_DATA_TYPES_FLAGS_::_FP64_:
        ...
        // configure the process domain for each thread
        decx::utils::frag_manager_gen(&f_mgr, _A->_length / 4, t1D->total_thread);
        decx::calc::operators_caller_c_fp64(decx::calc::CPUK::fms_c_dvec4_ST,
