...
_DECX_API_ de::DH de::cpu::Mul(de::Vector& A, de::Vector& B, de::Vector& dst)
{
    de::DH handle;
...
_DECX_API_ de::DH de::cpu::Mul(de::Vector& src, void* __x, de::Vector& dst)
{
    de::DH handle;
    if (!decx::cpu::_is_CPU_init()) {
        decx::err::handle_error_info_modify(&handle, decx::DECX_error_types::DECX_FAIL_CPU_not_init,
    ...
    case de::_DATA_TYPES_FLAGS_::_FP64_:
        ...
        decx::calc::operators_caller_c<decx::calc::_fp64_binary_ops_c, double, 8>(decx::calc::CPUK::mul_c_dvec4_ST,
    ...
    case de::_DATA_TYPES_FLAGS_::_COMPLEX_F32_:
        ...
        decx::calc::operators_caller_c<decx::calc::_fp64_binary_ops_c, double, 8>(decx::calc::CPUK::cp_mul_c_fvec4_ST,
            (double*)_src->Vec.ptr, *((double*)__x), (double*)_dst->Vec.ptr, t1D, &f_mgr);
        break;
    default:
        break;
