...
de::DH de::cuda::Mul(de::GPU_Vector& A, de::GPU_Vector& B, de::GPU_Vector& dst)
{
    ...
    case decx::_DATA_TYPES_FLAGS_::_FP16_:
        decx::calc::dev_Kmul_m((de::Half*)_A.Vec.ptr, (de::Half*)_B.Vec.ptr, (de::Half*)_dst.Vec.ptr, len);
        break;

    case decx::_DATA_TYPES_FLAGS_::_FP32_:
        decx::calc::dev_Kmul_m((float*)_A.Vec.ptr, (float*)_B.Vec.ptr, (float*)_dst.Vec.ptr, len);
        break;

    case decx::_DATA_TYPES_FLAGS_::_INT32_:
        decx::calc::dev_Kmul_m((int*)_A.Vec.ptr, (int*)_B.Vec.ptr, (int*)_dst.Vec.ptr, len);
        break;

    case decx::_DATA_TYPES_FLAGS_::_FP64_:
        decx::calc::dev_Kmul_m((double*)_A.Vec.ptr, (double*)_B.Vec.ptr, (double*)_dst.Vec.ptr, len);
        break;
    default:
        break;
    }
...
de::DH de::cuda::Mul(de::GPU_Vector& A, void* __x, de::GPU_Vector& dst)
{
    ...
    {
    case decx::_DATA_TYPES_FLAGS_::_FP16_:
        decx::calc::dev_Kmul_c((de::Half*)_A.Vec.ptr, *((de::Half*)__x), (de::Half*)_dst.Vec.ptr, len);
        break;

    case decx::_DATA_TYPES_FLAGS_::_FP32_:
        decx::calc::dev_Kmul_c((float*)_A.Vec.ptr, *((float*)__x), (float*)_dst.Vec.ptr, len);
        break;

    case decx::_DATA_TYPES_FLAGS_::_INT32_:
        decx::calc::dev_Kmul_c((int*)_A.Vec.ptr, *((int*)__x), (int*)_dst.Vec.ptr, len);
        break;

    case decx::_DATA_TYPES_FLAGS_::_FP64_:
        decx::calc::dev_Kmul_c((double*)_A.Vec.ptr, *((double*)__x), (double*)_dst.Vec.ptr, len);
        break;
    default:
        break;
    }
