...
{
    namespace cpu {
        _DECX_API_ de::DH Fma(de::Vector& A, de::Vector& B, de::Vector& C, de::Vector& dst);


        _DECX_API_ de::DH Fma(de::Vector& src, void* __x, de::Vector& B, de::Vector& dst);
    }
}


_DECX_API_ de::DH de::cpu::Fma(de::Vector& A, de::Vector& B, de::Vector& C, de::Vector& dst)
{
    de::DH handle;
    if (!decx::cpI.is_init) {
...
_DECX_API_ de::DH de::cpu::Fma(de::Vector& A, void* __x, de::Vector& B, de::Vector& dst)
{
    de::DH handle;
    if (!decx::cpI.is_init) {
        Print_Error_Message(4, CPU_NOT_INIT);
