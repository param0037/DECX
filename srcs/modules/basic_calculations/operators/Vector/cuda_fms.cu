...
de::DH de::cuda::Fms(de::GPU_Vector& A, de::GPU_Vector& B, de::GPU_Vector& C, de::GPU_Vector& dst)
{
    ...
    case decx::_DATA_TYPES_FLAGS_::_FP16_:
        decx::calc::dev_Kfms_m((de::Half*)_A.Vec.ptr, (de::Half*)_B.Vec.ptr, (de::Half*)_C.Vec.ptr, (de::Half*)_dst.Vec.ptr, len);
        break;

    case decx::_DATA_TYPES_FLAGS_::_FP32_:
        decx::calc::dev_Kfms_m((float*)_A.Vec.ptr, (float*)_B.Vec.ptr, (float*)_C.Vec.ptr, (float*)_dst.Vec.ptr, len);
        break;

    case decx::_DATA_TYPES_FLAGS_::_INT32_:
        decx::calc::dev_Kfms_m((int*)_A.Vec.ptr, (int*)_B.Vec.ptr, (int*)_C.Vec.ptr, (int*)_dst.Vec.ptr, len);
        break;

    case decx::_DATA_TYPES_FLAGS_::_FP64_:
        decx::calc::dev_Kfms_m((double*)_A.Vec.ptr, (double*)_B.Vec.ptr, (double*)_C.Vec.ptr, (double*)_dst.Vec.ptr, len);
        break;
    default:
        break;
    }
...
de::DH de::cuda::Fms(de::GPU_Vector& A, void* __x, de::GPU_Vector& B, de::GPU_Vector& dst)
{
    ...
    {
    case decx::_DATA_TYPES_FLAGS_::_FP16_:
        decx::calc::dev_Kfms_c((de::Half*)_A.Vec.ptr, *((de::Half*)__x), (de::Half*)_B.Vec.ptr, (de::Half*)_dst.Vec.ptr, len);
        break;

    case decx::_DATA_TYPES_FLAGS_::_FP32_:
        decx::calc::dev_Kfms_c((float*)_A.Vec.ptr, *((float*)__x), (float*)_B.Vec.ptr, (float*)_dst.Vec.ptr, len);
        break;

    case decx::_DATA_TYPES_FLAGS_::_INT32_:
        decx::calc::dev_Kfms_c((int*)_A.Vec.ptr, *((int*)__x), (int*)_B.Vec.ptr, (int*)_dst.Vec.ptr, len);
        break;

    case decx::_DATA_TYPES_FLAGS_::_FP64_:
        decx::calc::dev_Kfms_c((double*)_A.Vec.ptr, *((double*)__x), (double*)_B.Vec.ptr, (double*)_dst.Vec.ptr, len);
        break;
    default:
        break;
    }
