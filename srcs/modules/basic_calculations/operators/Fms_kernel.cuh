...
namespace decx
{
    namespace calc {
        static void dev_Kfms_m(float* DA, float* DB, float* DC, float* Ddst, const size_t len) {
            ...
            decx::calc::GPUK::fms_m_fvec4 << <decx::utils::ceil<size_t>(len / 4, decx::cuP.prop.maxThreadsPerBlock), decx::cuP.prop.maxThreadsPerBlock >> > (
        ...
        static void dev_Kfms_m_2D(float* DA, float* DB, float* DC, float* Ddst, const size_t eq_pitch, const uint2 bounds) {
            ...
            decx::calc::GPUK::fms_m_fvec4_2D << <grid, block >> > (_DAptr, _DBptr, _DCptr, _Ddstptr, eq_pitch / 4, bounds);
        }
        ...
        static void dev_Kfms_m(int* DA, int* DB, int* DC, int* Ddst, const size_t len) {
            ...
            decx::calc::GPUK::fms_m_ivec4 << <decx::utils::ceil<size_t>(len / 4, decx::cuP.prop.maxThreadsPerBlock), decx::cuP.prop.maxThreadsPerBlock >> > (
                _DAptr, _DBptr, _DCptr, _Ddstptr, len / 4);
        }
        ...
        static void dev_Kfms_m_2D(int* DA, int* DB, int* DC, int* Ddst, const size_t eq_pitch, const uint2 bounds) {
            ...
            decx::calc::GPUK::fms_m_ivec4_2D << <grid, block >> > (_DAptr, _DBptr, _DCptr, _Ddstptr, eq_pitch / 4, bounds);
        }
        ...
        static void dev_Kfms_m(de::Half* DA, de::Half* DB, de::Half* DC, de::Half* Ddst, const size_t len) {
            ...
            decx::calc::GPUK::fms_m_hvec8 << <decx::utils::ceil<size_t>(len / 8, decx::cuP.prop.maxThreadsPerBlock), decx::cuP.prop.maxThreadsPerBlock >> > (
        ...
        static void dev_Kfms_m_2D(de::Half* DA, de::Half* DB, de::Half* DC, de::Half* Ddst, const size_t eq_pitch, const uint2 bounds) {
            ...
            decx::calc::GPUK::fms_m_hvec8_2D << <grid, block >> > (_DAptr, _DBptr, _DCptr, _Ddstptr, eq_pitch / 8, bounds);
        }
        ...
        static void dev_Kfms_m(double* DA, double* DB, double* DC, double* Ddst, const size_t len) {
            ...
            decx::calc::GPUK::fms_m_dvec2 << <decx::utils::ceil<size_t>(len / 2, decx::cuP.prop.maxThreadsPerBlock), decx::cuP.prop.maxThreadsPerBlock >> > (
        ...
        static void dev_Kfms_m_2D(double* DA, double* DB, double* DC, double* Ddst, const size_t eq_pitch, const uint2 bounds) {
            ...
            decx::calc::GPUK::fms_m_dvec2_2D << <grid, block >> > (_DAptr, _DBptr, _DCptr, _Ddstptr, eq_pitch / 2, bounds);
        }
        ...
        static void dev_Kfms_c(float* DA, float __x, float* DB, float* Ddst, const size_t len) {
            ...
            decx::calc::GPUK::fms_c_fvec4 << < decx::utils::ceil<size_t>(len / 4, decx::cuP.prop.maxThreadsPerBlock), decx::cuP.prop.maxThreadsPerBlock >> > (
        ...
        static void dev_Kfms_c_2D(float* DA, float __x, float* DB, float* Ddst, const size_t eq_pitch, const uint2 bounds) {
            ...
            decx::calc::GPUK::fms_c_fvec4_2D << <grid, block >> > (_DAptr, __x, _DBptr, _Ddstptr, eq_pitch / 4, bounds);
        }
        ...
        static void dev_Kfms_c(int* DA, int __x, int* DB, int* Ddst, const size_t len) {
            ...
            float4* Dptr_B = reinterpret_cast<float4*>(DB);
            float4* Dptr_dst = reinterpret_cast<float4*>(Ddst);
            decx::calc::GPUK::fms_c_ivec4 << < decx::utils::ceil<size_t>(len / 4, decx::cuP.prop.maxThreadsPerBlock), decx::cuP.prop.maxThreadsPerBlock >> > (
                Dptr_A, __x, Dptr_B, Dptr_dst, len / 4);
        }
        ...
        static void dev_Kfms_c_2D(int* DA, int __x, int* DB, int* Ddst, const size_t eq_pitch, const uint2 bounds) {
            ...
            decx::calc::GPUK::fms_c_ivec4_2D << <grid, block >> > (_DAptr, __x, _DBptr, _Ddstptr, eq_pitch / 4, bounds);
        }
        ...
        static void dev_Kfms_c(de::Half* DA, de::Half __x, de::Half* DB, de::Half* Ddst, const size_t len) {
            ...
            float4* Dptr_B = reinterpret_cast<float4*>(DB);
            float4* Dptr_dst = reinterpret_cast<float4*>(Ddst);
            decx::calc::GPUK::fms_c_hvec8 << < decx::utils::ceil<size_t>(len / 8, decx::cuP.prop.maxThreadsPerBlock), decx::cuP.prop.maxThreadsPerBlock >> > (
        ...
        static void dev_Kfms_c_2D(de::Half* DA, de::Half __x, de::Half* DB, de::Half* Ddst, const size_t eq_pitch, const uint2 bounds) {
            ...
            decx::calc::GPUK::fms_c_hvec8_2D << <grid, block >> > (_DAptr, _x, _DBptr, _Ddstptr, eq_pitch / 8, bounds);
        }
        ...
        static void dev_Kfms_c(double* DA, double __x, double* DB, double* Ddst, const size_t len) {
            ...
            float4* Dptr_B = reinterpret_cast<float4*>(DB);
            float4* Dptr_dst = reinterpret_cast<float4*>(Ddst);
            decx::calc::GPUK::fms_c_dvec2 << < decx::utils::ceil<size_t>(len / 2, decx::cuP.prop.maxThreadsPerBlock), decx::cuP.prop.maxThreadsPerBlock >> > (
        ...
        static void dev_Kfms_c_2D(double* DA, double __x, double* DB, double* Ddst, const size_t eq_pitch, const uint2 bounds) {
            ...
            decx::calc::GPUK::fms_c_dvec2_2D << <grid, block >> > (_DAptr, __x, _DBptr, _Ddstptr, eq_pitch / 2, bounds);
        }
    }
}
