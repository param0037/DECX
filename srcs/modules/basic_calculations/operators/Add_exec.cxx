...
decx::calc::CPUK::add_m_fvec8_ST(const float* __restrict A, const float* __restrict B, float* __restrict dst, size_t len)
{
...
_THREAD_FUNCTION_ void 
decx::calc::CPUK::add_m_ivec8_ST(const int* __restrict A, const int* __restrict B, int* __restrict dst, size_t len)
{
...
_THREAD_FUNCTION_ void 
decx::calc::CPUK::add_m_dvec4_ST(const double* __restrict A, const double* __restrict B, double* __restrict dst, size_t len)
{
...
_THREAD_FUNCTION_ void 
decx::calc::CPUK::add_c_fvec8_ST(const float* __restrict src, const float __x, float* __restrict dst, size_t len)
{
...
_THREAD_FUNCTION_ void 
decx::calc::CPUK::add_c_ivec8_ST(const int* __restrict src, const int __x, int* __restrict dst, size_t len)
{
...
_THREAD_FUNCTION_ void 
decx::calc::CPUK::add_c_dvec4_ST(const double* __restrict src, const double __x, double* __restrict dst, size_t len)
{
