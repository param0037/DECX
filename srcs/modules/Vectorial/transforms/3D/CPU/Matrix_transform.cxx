...
de::tf::cpu::Vec_transform(de::Vector& src, de::Vector& dst, de::Matrix& transform_matrix)
{
    ...
    if (_src->type == decx::_DATA_TYPES_FLAGS_::_VECTOR4F_ || _src->type == decx::_DATA_TYPES_FLAGS_::_VECTOR3F_) {
        ...
        if (_src->type == decx::_DATA_TYPES_FLAGS_::_VECTOR4F_) {
        ...
        for (int i = 0; i < t1D.total_thread - 1; ++i) {
            t1D._async_thread[i] = decx::cpu::register_task(&decx::thread_pool, kernel, _loc_src_ptr, _loc_dst_ptr,
        ...
        t1D._async_thread[t1D.total_thread - 1] = decx::cpu::register_task(&decx::thread_pool, kernel, _loc_src_ptr, _loc_dst_ptr,
            _tf_mat4_by_4, _L);
    }
    else {
