...
decx::MemChunk_Hf::MemChunk_Hf(int pool_dex, int chunk_set_dex)
{
    this->chunk_size = 0;
...
decx::MemChunk_Hf::MemChunk_Hf(size_t size, size_t req_size, int pool_dex, int chunk_set_dex)
{
    this->chunk_size = size;

    uchar* ptr = (uchar*)decx::alloc::aligned_malloc_Hf(size, host_mem_alignment);
    this->header_ptr = ptr;
    int3 _loc;
    _loc.x = pool_dex;        _loc.y = chunk_set_dex;        _loc.z = 0;
...
decx::MemBlock* decx::MemChunk_Hf::split(int dex, size_t req_size)
{
...
decx::MemBlock* decx::MemChunk_Hf::forward_merge2(int dex)
{
...
decx::MemBlock* decx::MemChunk_Hf::backward_merge2(int dex)
{
    return decx::MemChunk_Hf::forward_merge2(dex + 1);
}


decx::MemBlock* decx::MemChunk_Hf::merge3(int dex)
{
...
void decx::MemChunk_Hf::check_to_merge(int dex)
{
    decx::MemBlock* this_bl = *(this->mem_block_list.begin() + dex);
...
decx::MemChunkSet_Hf::MemChunkSet_Hf(int pool_dex)
{
