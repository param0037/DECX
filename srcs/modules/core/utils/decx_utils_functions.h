...
__host__ __device__
        ...
        */
        ...
        static _Out_Type* ptr_shift_xy(_In_Type* _initial_ptr, const uint __x, const uint __y, const size_t _pitch);
...
_Out_Type* decx::utils::ptr_shift_xy(_In_Type* _initial_ptr, const uint __x, const uint __y, const size_t _pitch)
{
