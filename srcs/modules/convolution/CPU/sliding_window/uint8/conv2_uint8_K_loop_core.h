                                              ...
                                              const uint            _loop)
{
    ...
    for (int i = 0; i < ker_dims.y; ++i) 
    {
        for (uint j = 0; j < _loop; ++j) {
            ...
            _CONV2_REGS_UINT8_I32_SHIFT_FMADD16_(1);         _CONV2_REGS_UINT8_I32_SHIFT_FMADD16_(2);
            _CONV2_REGS_UINT8_I32_SHIFT_FMADD16_(3);         _CONV2_REGS_UINT8_I32_SHIFT_FMADD16_(4);
            _CONV2_REGS_UINT8_I32_SHIFT_FMADD16_(5);         _CONV2_REGS_UINT8_I32_SHIFT_FMADD16_(6);
            _CONV2_REGS_UINT8_I32_SHIFT_FMADD16_(7);         _CONV2_REGS_UINT8_I32_SHIFT_FMADD16_(8);
            _CONV2_REGS_UINT8_I32_SHIFT_FMADD16_(9);         _CONV2_REGS_UINT8_I32_SHIFT_FMADD16_(10);
            _CONV2_REGS_UINT8_I32_SHIFT_FMADD16_(11);        _CONV2_REGS_UINT8_I32_SHIFT_FMADD16_(12);
            _CONV2_REGS_UINT8_I32_SHIFT_FMADD16_(13);        _CONV2_REGS_UINT8_I32_SHIFT_FMADD16_(14);
            _CONV2_REGS_UINT8_I32_SHIFT_FMADD16_(15);
        }
                                                        ...
                                                        const uint            _loop)
{
    ...
    for (int i = 0; i < ker_dims.y; ++i) 
    {
        for (uint j = 0; j < _loop; ++j) {
            ...
            _CONV2_REGS_UINT8_I32_SHIFT_FMADD8_(1);         _CONV2_REGS_UINT8_I32_SHIFT_FMADD8_(2);
            _CONV2_REGS_UINT8_I32_SHIFT_FMADD8_(3);         _CONV2_REGS_UINT8_I32_SHIFT_FMADD8_(4);
            _CONV2_REGS_UINT8_I32_SHIFT_FMADD8_(5);         _CONV2_REGS_UINT8_I32_SHIFT_FMADD8_(6);
            _CONV2_REGS_UINT8_I32_SHIFT_FMADD8_(7);         _CONV2_REGS_UINT8_I32_SHIFT_FMADD8_(8);
            _CONV2_REGS_UINT8_I32_SHIFT_FMADD8_(9);         _CONV2_REGS_UINT8_I32_SHIFT_FMADD8_(10);
            _CONV2_REGS_UINT8_I32_SHIFT_FMADD8_(11);        _CONV2_REGS_UINT8_I32_SHIFT_FMADD8_(12);
            _CONV2_REGS_UINT8_I32_SHIFT_FMADD8_(13);        _CONV2_REGS_UINT8_I32_SHIFT_FMADD8_(14);
            _CONV2_REGS_UINT8_I32_SHIFT_FMADD8_(15);
        }
                                              ...
                                              const uint            _loop)
{
    ...
    for (int i = 0; i < ker_dims.y; ++i) 
    {
        for (uint j = 0; j < _loop; ++j) {
            ...
            /*_CONV2_REGS_UINT8_F32_SHIFT_FMADD16_(1);         _CONV2_REGS_UINT8_F32_SHIFT_FMADD16_(2);
            _CONV2_REGS_UINT8_F32_SHIFT_FMADD16_(3);         _CONV2_REGS_UINT8_F32_SHIFT_FMADD16_(4);
            _CONV2_REGS_UINT8_F32_SHIFT_FMADD16_(5);         _CONV2_REGS_UINT8_F32_SHIFT_FMADD16_(6);
            _CONV2_REGS_UINT8_F32_SHIFT_FMADD16_(7);         _CONV2_REGS_UINT8_F32_SHIFT_FMADD16_(8);
            _CONV2_REGS_UINT8_F32_SHIFT_FMADD16_(9);         _CONV2_REGS_UINT8_F32_SHIFT_FMADD16_(10);
            _CONV2_REGS_UINT8_F32_SHIFT_FMADD16_(11);        _CONV2_REGS_UINT8_F32_SHIFT_FMADD16_(12);
            _CONV2_REGS_UINT8_F32_SHIFT_FMADD16_(13);        _CONV2_REGS_UINT8_F32_SHIFT_FMADD16_(14);
            _CONV2_REGS_UINT8_F32_SHIFT_FMADD16_(15);        */ 
            for (int k = 0; k < 15; ++k) {
                                                        ...
                                                        const uint            _loop)
{
    ...
    for (int i = 0; i < ker_dims.y; ++i) 
    {
        for (uint j = 0; j < _loop; ++j) {
            ...
            /*_CONV2_REGS_UINT8_F32_SHIFT_FMADD8_(1);         _CONV2_REGS_UINT8_F32_SHIFT_FMADD8_(2);
            _CONV2_REGS_UINT8_F32_SHIFT_FMADD8_(3);         _CONV2_REGS_UINT8_F32_SHIFT_FMADD8_(4);
            _CONV2_REGS_UINT8_F32_SHIFT_FMADD8_(5);         _CONV2_REGS_UINT8_F32_SHIFT_FMADD8_(6);
            _CONV2_REGS_UINT8_F32_SHIFT_FMADD8_(7);         _CONV2_REGS_UINT8_F32_SHIFT_FMADD8_(8);
            _CONV2_REGS_UINT8_F32_SHIFT_FMADD8_(9);         _CONV2_REGS_UINT8_F32_SHIFT_FMADD8_(10);
            _CONV2_REGS_UINT8_F32_SHIFT_FMADD8_(11);        _CONV2_REGS_UINT8_F32_SHIFT_FMADD8_(12);
            _CONV2_REGS_UINT8_F32_SHIFT_FMADD8_(13);        _CONV2_REGS_UINT8_F32_SHIFT_FMADD8_(14);
            _CONV2_REGS_UINT8_F32_SHIFT_FMADD8_(15);*/
            for (int k = 0; k < 15; ++k) {
