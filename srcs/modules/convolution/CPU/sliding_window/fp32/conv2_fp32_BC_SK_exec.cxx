                                       ...
                                       decx::_C2_MK32* conv2_props)
{
    ...
    t1D->_async_thread[0] = decx::cpu::register_task(&decx::thread_pool,decx::conv::CPUK::_conv2_rN_BC_SK_fp32_ST_top,
    ...
    {
        t1D->_async_thread[i] = decx::cpu::register_task(&decx::thread_pool,decx::conv::CPUK::_conv2_rN_BC_SK_fp32_ST_mid,
            tmp_src_ptr, tmp_cache_src, kernel, tmp_dst_ptr,
            make_uint2(proc_dim.x, conv2_props->f_mgr->frag_len), conv2_props);
    ...
    if (conv2_props->f_mgr->frag_left_over != 0) {
        t1D->_async_thread[t1D->total_thread - 1] = decx::cpu::register_task(&decx::thread_pool,decx::conv::CPUK::_conv2_rN_BC_SK_fp32_ST_bottom,
                                          ...
                                          decx::_C2_MK32* conv2_props)
{
    ...
    t1D->_async_thread[0] = decx::cpu::register_task(&decx::thread_pool,decx::conv::CPUK::_conv2_r1_r4_BC_SK_fp32_ST_top,
        tmp_src_ptr, tmp_cache_src, kernel, tmp_dst_ptr,
        make_uint2(proc_dim.x, conv2_props->f_mgr->frag_len), conv2_props);
    ...
    for (int i = 1; i < t1D->total_thread - 1; ++i)
    {
        t1D->_async_thread[i] = decx::cpu::register_task(&decx::thread_pool,decx::conv::CPUK::_conv2_r1_r4_BC_SK_fp32_ST_mid,
            tmp_src_ptr, tmp_cache_src, kernel, tmp_dst_ptr,
            make_uint2(proc_dim.x, conv2_props->f_mgr->frag_len), conv2_props);
    ...
    if (conv2_props->f_mgr->frag_left_over != 0) {
        t1D->_async_thread[t1D->total_thread - 1] = decx::cpu::register_task(&decx::thread_pool,decx::conv::CPUK::_conv2_r1_r4_BC_SK_fp32_ST_bottom,
            tmp_src_ptr, tmp_cache_src, kernel, tmp_dst_ptr, make_uint2(proc_dim.x, conv2_props->f_mgr->frag_left_over),
            conv2_props);
    }
    else {
