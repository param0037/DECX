                                       ...
                                       decx::_C2_MK32*                conv2_mk_props)
{
    ...
    if (conv2_mk_props->f_mgr->frag_left_over != 0) {
        ...
        {
            t1D->_async_thread[i] = decx::cpu::register_task(&decx::thread_pool, decx::conv::CPUK::_conv2_rN_NB_SK_fp32_ST,
        ...
        t1D->_async_thread[t1D->total_thread - 1] = decx::cpu::register_task(&decx::thread_pool, decx::conv::CPUK::_conv2_rN_NB_SK_fp32_ST,
            tmp_src_ptr, kernel, tmp_dst_ptr,
                                          ...
                                          decx::_C2_MK32*              conv2_mk_props)
{
    ...
    if (conv2_mk_props->f_mgr->frag_left_over != 0) {
        for (int i = 0; i < t1D->total_thread - 1; ++i)
        {
            t1D->_async_thread[i] = decx::cpu::register_task(&decx::thread_pool, decx::conv::CPUK::_conv2_r1_r4_NB_SK_fp32_ST,
                tmp_src_ptr, kernel, tmp_dst_ptr,
                make_uint2(proc_dim.x, conv2_mk_props->f_mgr->frag_len),
                conv2_mk_props->page_size_src, conv2_mk_props->page_size_dst, conv2_mk_props->ker_dims,
                conv2_mk_props->channel_size, conv2_mk_props->Wsrc, conv2_mk_props->Wdst);
        ...
        t1D->_async_thread[t1D->total_thread - 1] = decx::cpu::register_task(&decx::thread_pool, decx::conv::CPUK::_conv2_r1_r4_NB_SK_fp32_ST,
            tmp_src_ptr, kernel, tmp_dst_ptr,
            make_uint2(proc_dim.x, conv2_mk_props->f_mgr->frag_left_over), 
            conv2_mk_props->page_size_src, conv2_mk_props->page_size_dst, conv2_mk_props->ker_dims,
            conv2_mk_props->channel_size, conv2_mk_props->Wsrc, conv2_mk_props->Wdst);
