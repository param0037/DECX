...
{
    namespace conv{
        static void _conv2_r8_NB_SK_fp32_organiser(float* src, float* kernel, float* dst,
...
void decx::conv::_conv2_r8_NB_SK_fp32_organiser(float*                     src,
                                       float*                        kernel, 
                                       float*                        dst,
                                       ...
                                       decx::_C2_MK32*                 conv2_mk_props)
{
    ...
    if (half_kernel_w < 5) {
        decx::conv::_conv2_r1_r4_NB_SK_fp32_caller(src, kernel, dst, proc_dim, t1D, conv2_mk_props);
    }
    else {
        decx::conv::_conv2_rN_NB_SK_fp32_caller(src, kernel, dst, proc_dim, t1D, conv2_mk_props);
    }
}
