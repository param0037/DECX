...
__global__ void 
decx::conv_I2R::GPUK::cu_Im2Row_v128_r8_within(float4*                       src,
                                       float4*                       dst,
...
__global__ void 
decx::conv_I2R::GPUK::cu_sIm2Row_r1_exact(float4*                       src,
                          float4*                       dst,
                          const int2                    thread_bound,
                          const size_t                  Wpitch_src,
                          const size_t                  pitch_dst,
...
__global__ void 
decx::conv_I2R::GPUK::cu_sIm2Row_r2_exact(float4*                       src,
                          float4*                       dst,
                          const int2                    thread_bound,
                          const size_t                  Wpitch_src,
                          const size_t                  pitch_dst,
