...
#ifndef _CONV2_MK_IM2COL_FP32_H_
#define _CONV2_MK_IM2COL_FP32_H_
...
namespace decx
{
    static void sconv2_NB_r8_mk_im2col(
        decx::_Tensor* src, decx::_TensorArray* kernel, decx::_Tensor* dst, decx::cuda_stream *S);


    static void sconv2_BC_r8_mk_im2col(
        decx::_Tensor* src, decx::_TensorArray* kernel, decx::_Tensor* dst, decx::cuda_stream *S);
}
...
* 
*/
static void decx::sconv2_NB_r8_mk_im2col(
    decx::_Tensor* src, decx::_TensorArray* kernel, decx::_Tensor* dst, decx::cuda_stream *S)
{
    ...
    decx::conv::GPUK::cu_conv_eq_mm_fp32 << <grid_eqMM, block_eqMM, 0, S->get_raw_stream_ref() >> > (I2C_buf.ptr,
                                                        ker_buf.ptr, 
                                                        dst_buf.ptr, 
                                                        MatA_load_bounds,
                                                        actual_dst_buf_W / 4,
...
static void decx::sconv2_BC_r8_mk_im2col(
    decx::_Tensor* src, decx::_TensorArray* kernel, decx::_Tensor* dst, decx::cuda_stream *S)
{
