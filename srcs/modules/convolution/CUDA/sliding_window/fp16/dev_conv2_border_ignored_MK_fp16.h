...
#ifndef _DEV_CONV2_BORDER_IGNORED_MK_FP16_H_
#define _DEV_CONV2_BORDER_IGNORED_MK_FP16_H_
...
namespace decx
{
    static void dev_main_loop_hconv2_mk_within8x8_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    ...
    static void dev_main_loop_hconv2_mk_exact8x8_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
        float4* Dsrc, float4* Ddst, decx::cuda_stream* S, const int flag);



    static void dev_main_loop_hconv2_mk_within8x16_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
        float4* Dsrc, float4* Ddst, decx::cuda_stream* S, const int flag);


    static void dev_main_loop_hconv2_mk_exact8x16_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
        float4* Dsrc, float4* Ddst, decx::cuda_stream* S, const int flag);


    static void dev_main_loop_hconv2_mk_within16x8_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
        float4* Dsrc, float4* Ddst, decx::cuda_stream* S, const int flag);


    static void dev_main_loop_hconv2_mk_exact16x8_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
        float4* Dsrc, float4* Ddst, decx::cuda_stream* S, const int flag);


    static void dev_main_loop_hconv2_mk_within16x16_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
        float4* Dsrc, float4* Ddst, decx::cuda_stream* S, const int flag);


    static void dev_main_loop_hconv2_mk_exact16x16_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
        float4* Dsrc, float4* Ddst, decx::cuda_stream* S, const int flag);
}
...
static void decx::dev_main_loop_hconv2_mk_within8x8_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
    float4* Dsrc, float4* Ddst, decx::cuda_stream* S, const int flag)
{
    int2 src_diff;
...
static void decx::dev_main_loop_hconv2_mk_exact8x8_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
    float4* Dsrc, float4* Ddst, decx::cuda_stream* S, const int flag)
{
    size_t offset_lin, offset_ker;
...
static void decx::dev_main_loop_hconv2_mk_within8x16_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
    float4* Dsrc, float4* Ddst, decx::cuda_stream* S, const int flag)
{
    int2 src_diff;
...
static void decx::dev_main_loop_hconv2_mk_exact8x16_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
    float4* Dsrc, float4* Ddst, decx::cuda_stream* S, const int flag)
{
    size_t offset_lin, offset_ker;
...
static void decx::dev_main_loop_hconv2_mk_within16x8_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
    float4* Dsrc, float4* Ddst, decx::cuda_stream* S, const int flag)
{
    int2 src_diff;
...
static void decx::dev_main_loop_hconv2_mk_exact16x8_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
    float4* Dsrc, float4* Ddst, decx::cuda_stream* S, const int flag)
{
    size_t offset_lin, offset_ker;
...
static void decx::dev_main_loop_hconv2_mk_within16x16_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
    float4* Dsrc, float4* Ddst, decx::cuda_stream* S, const int flag)
{
    int2 src_diff;
...
static void decx::dev_main_loop_hconv2_mk_exact16x16_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
    float4* Dsrc, float4* Ddst, decx::cuda_stream* S, const int flag)
{
    size_t offset_lin, offset_ker;
...
namespace decx
{
    static void dev_Conv2_NB_R8x8_MK(
           decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst, de::DH *handle, const int flag);


    static void dev_Conv2_NB_R8x16_MK(
           decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst, de::DH *handle, const int flag);


    static void dev_Conv2_NB_R16x8_MK(
           decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst, de::DH *handle, const int flag);


    static void dev_Conv2_NB_R16x16_MK(
           decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst, de::DH *handle, const int flag);


    static void dev_hConv2_border_ignore_mk(
           decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst, de::DH* handle, const int flag);
}


// single kernel
static void decx::dev_Conv2_NB_R8x8_MK(
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst, de::DH* handle, const int flag)
{
    int2 Dsrc_alloc_dim,
        Ddst_alloc_dim,
...
// single kernel
static void decx::dev_Conv2_NB_R8x16_MK(
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst, de::DH* handle, const int flag)
{
    int2 Dsrc_alloc_dim,
        Ddst_alloc_dim,
    ...
    if (ker_dim.x == (bounded_kernel_R16 * 2 + 1) && ker_dim.y == (bounded_kernel_R8 * 2 + 1)) {
        decx::dev_main_loop_hconv2_mk_exact8x16_NB(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, dev_buffer1.ptr, dev_buffer2.ptr, S, flag);
    }
    else {
        decx::dev_main_loop_hconv2_mk_within8x16_NB(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, dev_buffer1.ptr, dev_buffer2.ptr, S, flag);
    }
...
// single kernel
static void decx::dev_Conv2_NB_R16x8_MK(
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst, de::DH* handle, const int flag)
{
    int2 Dsrc_alloc_dim,
        Ddst_alloc_dim,
    ...
    if (ker_dim.x == (bounded_kernel_R8 * 2 + 1) && ker_dim.y == (bounded_kernel_R16 * 2 + 1)) {
        decx::dev_main_loop_hconv2_mk_exact16x8_NB(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, dev_buffer1.ptr, dev_buffer2.ptr, S, flag);
    }
    else {
        decx::dev_main_loop_hconv2_mk_within16x8_NB(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, dev_buffer1.ptr, dev_buffer2.ptr, S, flag);
    }
...
// single kernel
static void decx::dev_Conv2_NB_R16x16_MK(
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst, de::DH* handle, const int flag)
{
    int2 Dsrc_alloc_dim,
        Ddst_alloc_dim,
    ...
    if (ker_dim.x == (bounded_kernel_R16 * 2 + 1) && ker_dim.y == (bounded_kernel_R16 * 2 + 1)) {
        decx::dev_main_loop_hconv2_mk_exact16x16_NB(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, dev_buffer1.ptr, dev_buffer2.ptr, S, flag);
    }
    else {
        decx::dev_main_loop_hconv2_mk_within16x16_NB(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, dev_buffer1.ptr, dev_buffer2.ptr, S, flag);
    }
...
static void decx::dev_hConv2_border_ignore_mk(
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst, de::DH* handle, const int flag)
{
    int2 half_ker_dim;
    ...
    if (half_ker_dim.x < bounded_kernel_R8 + 1) {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            decx::dev_Conv2_NB_R8x8_MK(src, kernel, dst, handle, flag);
        }
        else {
            decx::dev_Conv2_NB_R16x8_MK(src, kernel, dst, handle, flag);
        }
    }
    else {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            decx::dev_Conv2_NB_R8x16_MK(src, kernel, dst, handle, flag);
        }
        else {
            decx::dev_Conv2_NB_R16x16_MK(src, kernel, dst, handle, flag);
        }
    }
    decx::Success(handle);
}
