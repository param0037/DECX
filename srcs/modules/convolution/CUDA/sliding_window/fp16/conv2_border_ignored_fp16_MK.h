...
#ifndef _CONV2_BORDER_IGNORED_MK_FP16_H_
#define _CONV2_BORDER_IGNORED_MK_FP16_H_
...
namespace decx
{
    static void main_loop_hconv2_mk_within8x8_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    ...
    static void main_loop_hconv2_mk_exact8x8_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim,
            int2* ker_dim, decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst,
            MIF<float4>* Dmem1, MIF<float4>* Dmem2, MIF<float4>* Dmem3, MIF<float4>* Dmem4,
        decx::cuda_stream* S[3], const int flag);


    static void main_loop_hconv2_mk_within8x16_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst,
        MIF<float4>* Dmem1, MIF<float4>* Dmem2, MIF<float4>* Dmem3, MIF<float4>* Dmem4,
        decx::cuda_stream* S[3], const int flag);


    static void main_loop_hconv2_mk_exact8x16_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst,
        MIF<float4>* Dmem1, MIF<float4>* Dmem2, MIF<float4>* Dmem3, MIF<float4>* Dmem4,
        decx::cuda_stream* S[3], const int flag);


    static void main_loop_hconv2_mk_within16x8_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst,
        MIF<float4>* Dmem1, MIF<float4>* Dmem2, MIF<float4>* Dmem3, MIF<float4>* Dmem4,
        decx::cuda_stream* S[3], const int flag);


    static void main_loop_hconv2_mk_exact16x8_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst,
        MIF<float4>* Dmem1, MIF<float4>* Dmem2, MIF<float4>* Dmem3, MIF<float4>* Dmem4,
        decx::cuda_stream* S[3], const int flag);


    static void main_loop_hconv2_mk_within16x16_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst,
        MIF<float4>* Dmem1, MIF<float4>* Dmem2, MIF<float4>* Dmem3, MIF<float4>* Dmem4,
        decx::cuda_stream* S[3], const int flag);


    static void main_loop_hconv2_mk_exact16x16_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst,
        MIF<float4>* Dmem1, MIF<float4>* Dmem2, MIF<float4>* Dmem3, MIF<float4>* Dmem4,
        decx::cuda_stream* S[3], const int flag);
}
...
static void decx::main_loop_hconv2_mk_within8x8_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst,
        MIF<float4>* Dmem1, MIF<float4>* Dmem2, MIF<float4>* Dmem3, MIF<float4>* Dmem4,
    decx::cuda_stream* S[3], const int flag)
{
    ...
    main_loop_regulable_R_mk(
        decx::hconv2_kernel_within8x8_offset(Dmem1->mem, Dmem3->mem, src_diff, *Dsrc_alloc_dim, *Ddst_alloc_dim, *ker_dim, sym_cpy_offset / sizeof(de::Half), S[0], flag),
        decx::hconv2_kernel_within8x8_offset(Dmem2->mem, Dmem4->mem, src_diff, *Dsrc_alloc_dim, *Ddst_alloc_dim, *ker_dim, sym_cpy_offset / sizeof(de::Half), S[0], flag),
        conv3_main_loop_MemCpyHtoD_within_NB_MK(de::Half, 8),
        de::Half);
...
static void decx::main_loop_hconv2_mk_exact8x8_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst,
        MIF<float4>* Dmem1, MIF<float4>* Dmem2, MIF<float4>* Dmem3, MIF<float4>* Dmem4,
    decx::cuda_stream* S[3], const int flag)
{
    ...
    main_loop_regulable_R_mk(
        ...
        conv3_main_loop_MemCpyHtoD_exact_NB_MK(de::Half),
        de::Half);
...
static void decx::main_loop_hconv2_mk_within8x16_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst,
        MIF<float4>* Dmem1, MIF<float4>* Dmem2, MIF<float4>* Dmem3, MIF<float4>* Dmem4,
    decx::cuda_stream* S[3], const int flag)
{
...
static void decx::main_loop_hconv2_mk_exact8x16_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst,
        MIF<float4>* Dmem1, MIF<float4>* Dmem2, MIF<float4>* Dmem3, MIF<float4>* Dmem4,
    decx::cuda_stream* S[3], const int flag)
{
    ...
    main_loop_regulable_R_mk(
        hconv2_kernel_exact8x16_offset(Dmem1->mem, Dmem3->mem, *Dsrc_alloc_dim, *Ddst_alloc_dim, *ker_dim, sym_cpy_offset / sizeof(de::Half), S[0], flag),
        hconv2_kernel_exact8x16_offset(Dmem2->mem, Dmem4->mem, *Dsrc_alloc_dim, *Ddst_alloc_dim, *ker_dim, sym_cpy_offset / sizeof(de::Half), S[0], flag),
        conv3_main_loop_MemCpyHtoD_exact_NB_MK(de::Half),
        de::Half);
...
static void decx::main_loop_hconv2_mk_within16x8_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst,
    MIF<float4>* Dmem1, MIF<float4>* Dmem2, MIF<float4>* Dmem3, MIF<float4>* Dmem4,
    decx::cuda_stream* S[3], const int flag)
{
...
static void decx::main_loop_hconv2_mk_exact16x8_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst,
    MIF<float4>* Dmem1, MIF<float4>* Dmem2, MIF<float4>* Dmem3, MIF<float4>* Dmem4,
    decx::cuda_stream* S[3], const int flag)
{
...
static void decx::main_loop_hconv2_mk_within16x16_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst,
    MIF<float4>* Dmem1, MIF<float4>* Dmem2, MIF<float4>* Dmem3, MIF<float4>* Dmem4,
    decx::cuda_stream* S[3], const int flag)
{
...
static void decx::main_loop_hconv2_mk_exact16x16_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst,
    MIF<float4>* Dmem1, MIF<float4>* Dmem2, MIF<float4>* Dmem3, MIF<float4>* Dmem4,
    decx::cuda_stream* S[3], const int flag)
{
...
namespace decx
{
    static void _Conv2_NB_R8x8_MK_fp16(
        decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst, de::DH* handle, const int flag);


    static void _Conv2_NB_R8x16_MK_fp16(
        decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst, de::DH* handle, const int flag);


    static void _Conv2_NB_R16x8_MK_fp16(
        decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst, de::DH* handle, const int flag);


    static void _Conv2_NB_R16x16_MK_fp16(
        decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst, de::DH* handle, const int flag);


    static void hConv2_border_ignore_mk(
        decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst, de::DH* handle, const int flag);
}


// single kernel
static void decx::_Conv2_NB_R8x8_MK_fp16(
    decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst, de::DH *handle, const int flag)
{
...
// single kernel
static void decx::_Conv2_NB_R8x16_MK_fp16(
    decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst, de::DH* handle, const int flag)
{
    MIF<float4> Dmem1, Dmem2,    // for src
        Dmem3, Dmem4;            // for dst
    ...
    for (int k = 0; k < kernel->height; ++k) {
        cudaMemcpyToSymbolAsync(Const_Mem, (de::Half*)kernel->MatptrArr.ptr[0] + offset_ker,
            kernel->width * sizeof(de::Half), offset_lin * sizeof(de::Half), cudaMemcpyHostToDevice, S[0]->get_raw_stream_ref());
        offset_lin += kernel->width;
        offset_ker += kernel->pitch;
    }
    ...
    if (ker_dim.x == (bounded_kernel_R16 * 2 + 1) && ker_dim.y == (bounded_kernel_R8 * 2 + 1)) {
        main_loop_hconv2_mk_exact8x16_NB(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, &Dmem1, &Dmem2, &Dmem3, &Dmem4, S, flag);
    }
    else {
        main_loop_hconv2_mk_within8x16_NB(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, &Dmem1, &Dmem2, &Dmem3, &Dmem4, S, flag);
    }
...
// single kernel
static void decx::_Conv2_NB_R16x8_MK_fp16(
    decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst, de::DH* handle, const int flag)
{
    MIF<float4> Dmem1, Dmem2,    // for src
        Dmem3, Dmem4;            // for dst
    ...
    if (ker_dim.x == (bounded_kernel_R8 * 2 + 1) && ker_dim.y == (bounded_kernel_R16 * 2 + 1)) {
        main_loop_hconv2_mk_exact16x8_NB(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, &Dmem1, &Dmem2, &Dmem3, &Dmem4, S, flag);
    }
    else {
        main_loop_hconv2_mk_within16x8_NB(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, &Dmem1, &Dmem2, &Dmem3, &Dmem4, S, flag);
    }
...
// single kernel
static void decx::_Conv2_NB_R16x16_MK_fp16(
    decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst, de::DH* handle, const int flag)
{
    MIF<float4> Dmem1, Dmem2,    // for src
        Dmem3, Dmem4;            // for dst
    ...
    if (ker_dim.x == (bounded_kernel_R16 * 2 + 1) && ker_dim.y == (bounded_kernel_R16 * 2 + 1)) {
        main_loop_hconv2_mk_exact16x16_NB(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, &Dmem1, &Dmem2, &Dmem3, &Dmem4, S, flag);
    }
    else {
        main_loop_hconv2_mk_within16x16_NB(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, &Dmem1, &Dmem2, &Dmem3, &Dmem4, S, flag);
    }
...
static void decx::hConv2_border_ignore_mk(
    decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst, de::DH* handle, const int flag)
{
    int2 half_ker_dim;
    ...
    if (half_ker_dim.x < bounded_kernel_R8 + 1) {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            decx::_Conv2_NB_R8x8_MK_fp16(src, kernel, dst, handle, flag);
        }
        else {
            decx::_Conv2_NB_R16x8_MK_fp16(src, kernel, dst, handle, flag);
        }
    }
    else {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            decx::_Conv2_NB_R8x16_MK_fp16(src, kernel, dst, handle, flag);
        }
        else {
            decx::_Conv2_NB_R16x16_MK_fp16(src, kernel, dst, handle, flag);
        }
    }
}
