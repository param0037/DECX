...
#ifndef _DEV_CONV2_BORDER_IGNORED_SK_FP16_H_
#define _DEV_CONV2_BORDER_IGNORED_SK_FP16_H_
...
namespace decx
{
    static void dev_main_loop_hconv2_sk_within8x8_NB(
    ...
    static void dev_main_loop_hconv2_sk_exact8x8_NB(
        int2* Dsrc_alloc_dim,                int2* Ddst_alloc_dim,                        int2* ker_dim,
        decx::_GPU_MatrixArray* src,        decx::_GPU_Matrix* kernel,                    decx::_GPU_MatrixArray* dst,
        float4* Dsrc,                        float4* Ddst,                                decx::cuda_stream *S, const int flag);


    static void dev_main_loop_hconv2_sk_within8x16_NB(
        int2* Dsrc_alloc_dim,                int2* Ddst_alloc_dim,                        int2* ker_dim,
        decx::_GPU_MatrixArray* src,        decx::_GPU_Matrix* kernel,                    decx::_GPU_MatrixArray* dst,
        float4* Dsrc,                        float4* Ddst,                                decx::cuda_stream *S, const int flag);


    static void dev_main_loop_hconv2_sk_exact8x16_NB(
        int2* Dsrc_alloc_dim,                int2* Ddst_alloc_dim,                        int2* ker_dim,
        decx::_GPU_MatrixArray* src,        decx::_GPU_Matrix* kernel,                    decx::_GPU_MatrixArray* dst,
        float4* Dsrc,                        float4* Ddst,                                decx::cuda_stream *S, const int flag);


    static void dev_main_loop_hconv2_sk_within16x8_NB(
        int2* Dsrc_alloc_dim,                int2* Ddst_alloc_dim,                        int2* ker_dim,
        decx::_GPU_MatrixArray* src,        decx::_GPU_Matrix* kernel,                    decx::_GPU_MatrixArray* dst,
        float4* Dsrc,                        float4* Ddst,                                decx::cuda_stream *S, const int flag);


    static void dev_main_loop_hconv2_sk_exact16x8_NB(
        int2* Dsrc_alloc_dim,                int2* Ddst_alloc_dim,                        int2* ker_dim,
        decx::_GPU_MatrixArray* src,        decx::_GPU_Matrix* kernel,                    decx::_GPU_MatrixArray* dst,
        float4* Dsrc,                        float4* Ddst,                                decx::cuda_stream *S, const int flag);


    static void dev_main_loop_hconv2_sk_within16x16_NB(
        int2* Dsrc_alloc_dim,                int2* Ddst_alloc_dim,                        int2* ker_dim,
        decx::_GPU_MatrixArray* src,        decx::_GPU_Matrix* kernel,                    decx::_GPU_MatrixArray* dst,
        float4* Dsrc,                        float4* Ddst,                                decx::cuda_stream *S, const int flag);


    static void dev_main_loop_hconv2_sk_exact16x16_NB(
        int2* Dsrc_alloc_dim,                int2* Ddst_alloc_dim,                        int2* ker_dim,
        decx::_GPU_MatrixArray* src,        decx::_GPU_Matrix* kernel,                    decx::_GPU_MatrixArray* dst,
        float4* Dsrc,                        float4* Ddst,                                decx::cuda_stream *S, const int flag);
}
...
static void decx::dev_main_loop_hconv2_sk_within8x8_NB(
        int2* Dsrc_alloc_dim,                int2* Ddst_alloc_dim,                        int2* ker_dim,
        decx::_GPU_MatrixArray* src,        decx::_GPU_Matrix* kernel,                    decx::_GPU_MatrixArray* dst,
        float4* Dsrc,                        float4* Ddst,                                decx::cuda_stream *S, const int flag)
{
    ...
    for (int i = 0; i < src->ArrayNumber; ++i) {
        checkCudaErrors(cudaMemcpy2DAsync(
            reinterpret_cast<de::Half*>(Dsrc) + src_diff.x * Dsrc_alloc_dim->x * 8 + src_diff.y,
...
static void decx::dev_main_loop_hconv2_sk_exact8x8_NB(
        int2* Dsrc_alloc_dim,                int2* Ddst_alloc_dim,                        int2* ker_dim,
        decx::_GPU_MatrixArray* src,        decx::_GPU_Matrix* kernel,                    decx::_GPU_MatrixArray* dst,
        float4* Dsrc,                        float4* Ddst,                                decx::cuda_stream *S, const int flag)
{
...
static void decx::dev_main_loop_hconv2_sk_within8x16_NB(
        int2* Dsrc_alloc_dim,                int2* Ddst_alloc_dim,                        int2* ker_dim,
        decx::_GPU_MatrixArray* src,        decx::_GPU_Matrix* kernel,                    decx::_GPU_MatrixArray* dst,
        float4* Dsrc,                        float4* Ddst,                                decx::cuda_stream *S, const int flag)
{
...
static void decx::dev_main_loop_hconv2_sk_exact8x16_NB(
        int2* Dsrc_alloc_dim,                int2* Ddst_alloc_dim,                        int2* ker_dim,
        decx::_GPU_MatrixArray* src,        decx::_GPU_Matrix* kernel,                    decx::_GPU_MatrixArray* dst,
        float4* Dsrc,                        float4* Ddst,                                decx::cuda_stream *S, const int flag)
{
...
static void decx::dev_main_loop_hconv2_sk_within16x8_NB(
        int2* Dsrc_alloc_dim,                int2* Ddst_alloc_dim,                        int2* ker_dim,
        decx::_GPU_MatrixArray* src,        decx::_GPU_Matrix* kernel,                    decx::_GPU_MatrixArray* dst,
        float4* Dsrc,                        float4* Ddst,                                decx::cuda_stream *S, const int flag)
{
...
static void decx::dev_main_loop_hconv2_sk_exact16x8_NB(
        int2* Dsrc_alloc_dim,                int2* Ddst_alloc_dim,                        int2* ker_dim,
        decx::_GPU_MatrixArray* src,        decx::_GPU_Matrix* kernel,                    decx::_GPU_MatrixArray* dst,
        float4* Dsrc,                        float4* Ddst,                                decx::cuda_stream *S, const int flag)
{
...
static void decx::dev_main_loop_hconv2_sk_within16x16_NB(
        int2* Dsrc_alloc_dim,                int2* Ddst_alloc_dim,                        int2* ker_dim,
        decx::_GPU_MatrixArray* src,        decx::_GPU_Matrix* kernel,                    decx::_GPU_MatrixArray* dst,
        float4* Dsrc,                        float4* Ddst,                                decx::cuda_stream *S, const int flag)
{
...
static void decx::dev_main_loop_hconv2_sk_exact16x16_NB(
        int2* Dsrc_alloc_dim,                int2* Ddst_alloc_dim,                        int2* ker_dim,
        decx::_GPU_MatrixArray* src,        decx::_GPU_Matrix* kernel,                    decx::_GPU_MatrixArray* dst,
        float4* Dsrc,                        float4* Ddst,                                decx::cuda_stream *S, const int flag)
{
...
namespace decx
{
    static void dev_Conv2_NB_R8x8_SK(
        decx::_GPU_MatrixArray* src, decx::_GPU_Matrix* kernel, decx::_GPU_MatrixArray* dst, de::DH *handle, const int flag);


    static void dev_Conv2_NB_R8x16_SK(
        decx::_GPU_MatrixArray* src, decx::_GPU_Matrix* kernel, decx::_GPU_MatrixArray* dst, de::DH *handle, const int flag);


    static void dev_Conv2_NB_R16x8_SK(
        decx::_GPU_MatrixArray* src, decx::_GPU_Matrix* kernel, decx::_GPU_MatrixArray* dst, de::DH *handle, const int flag);


    static void dev_Conv2_NB_R16x16_SK(
        decx::_GPU_MatrixArray* src, decx::_GPU_Matrix* kernel, decx::_GPU_MatrixArray* dst, de::DH *handle, const int flag);


    static void dev_hConv2_border_ignore_sk(
        decx::_GPU_MatrixArray* src, decx::_GPU_Matrix* kernel, decx::_GPU_MatrixArray* dst, de::DH* handle, const int flag);
}
...
// single kernel
static void decx::dev_Conv2_NB_R8x8_SK(
    decx::_GPU_MatrixArray* src, decx::_GPU_Matrix* kernel, decx::_GPU_MatrixArray* dst, de::DH* handle, const int flag)
{
    int2 Dsrc_alloc_dim,
        Ddst_alloc_dim,
    ...
    if (ker_dim.x == (bounded_kernel_R8 * 2 + 1) && ker_dim.y == (bounded_kernel_R8 * 2 + 1)) {
        decx::dev_main_loop_hconv2_sk_exact8x8_NB(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, Dsrc, Ddst, S, flag);
    }
    else {
        decx::dev_main_loop_hconv2_sk_within8x8_NB(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, Dsrc, Ddst, S, flag);
    }
...
// single kernel
static void decx::dev_Conv2_NB_R8x16_SK(
    decx::_GPU_MatrixArray* src, decx::_GPU_Matrix* kernel, decx::_GPU_MatrixArray* dst, de::DH* handle, const int flag)
{
    int2 Dsrc_alloc_dim,
        Ddst_alloc_dim,
    ...
    if (ker_dim.x == (bounded_kernel_R16 * 2 + 1) && ker_dim.y == (bounded_kernel_R8 * 2 + 1)) {
        decx::dev_main_loop_hconv2_sk_exact8x16_NB(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, Dsrc, Ddst, S, flag);
    }
    else {
        decx::dev_main_loop_hconv2_sk_within8x16_NB(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, Dsrc, Ddst, S, flag);
    }
...
// single kernel
static void decx::dev_Conv2_NB_R16x8_SK(
    decx::_GPU_MatrixArray* src, decx::_GPU_Matrix* kernel, decx::_GPU_MatrixArray* dst, de::DH* handle, const int flag)
{
    int2 Dsrc_alloc_dim,
        Ddst_alloc_dim,
    ...
    if (ker_dim.x == (bounded_kernel_R8 * 2 + 1) && ker_dim.y == (bounded_kernel_R16 * 2 + 1)) {
        decx::dev_main_loop_hconv2_sk_exact16x8_NB(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, Dsrc, Ddst, S, flag);
    }
    else {
        decx::dev_main_loop_hconv2_sk_within16x8_NB(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, Dsrc, Ddst, S, flag);
    }
...
// single kernel
static void decx::dev_Conv2_NB_R16x16_SK(
    decx::_GPU_MatrixArray* src, decx::_GPU_Matrix* kernel, decx::_GPU_MatrixArray* dst, de::DH* handle, const int flag)
{
    int2 Dsrc_alloc_dim,
        Ddst_alloc_dim,
    ...
    if (ker_dim.x == (bounded_kernel_R16 * 2 + 1) && ker_dim.y == (bounded_kernel_R16 * 2 + 1)) {
        decx::dev_main_loop_hconv2_sk_exact16x16_NB(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, Dsrc, Ddst, S, flag);
    }
    else {
        decx::dev_main_loop_hconv2_sk_within16x16_NB(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, Dsrc, Ddst, S, flag);
    }
...
static void decx::dev_hConv2_border_ignore_sk(
    decx::_GPU_MatrixArray* src, decx::_GPU_Matrix* kernel, decx::_GPU_MatrixArray* dst, de::DH* handle, const int flag)
{
    int2 half_ker_dim;
    ...
    if (half_ker_dim.x < bounded_kernel_R8 + 1) {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            decx::dev_Conv2_NB_R8x8_SK(src, kernel, dst, handle, flag);
        }
        else {
            decx::dev_Conv2_NB_R16x8_SK(src, kernel, dst, handle, flag);
        }
    }
    else {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            decx::dev_Conv2_NB_R8x16_SK(src, kernel, dst, handle, flag);
        }
        else {
            decx::dev_Conv2_NB_R16x16_SK(src, kernel, dst, handle, flag);
        }
    }
}
