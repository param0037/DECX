...
namespace decx
{
    ...
    */
    static void _Conv2_NB_R8x8_fp16(decx::_Matrix* src, decx::_Matrix* kernel, decx::_Matrix* dst, 
    ...
    * In order to save the device memory, just allocate memory of suitable size
    */
    static void _Conv2_NB_R16x8_fp16(decx::_Matrix* src, decx::_Matrix* kernel, decx::_Matrix* dst, 
        de::DH* handle, const int flag);
    ...
    * In order to save the device memory, just allocate memory of suitable size
    */
    static void _Conv2_NB_R8x16_fp16(decx::_Matrix* src, decx::_Matrix* kernel, decx::_Matrix* dst, 
        de::DH* handle, const int flag);
    ...
    * In order to save the device memory, just allocate memory of suitable size
    */
    static void _Conv2_NB_R16x16_fp16(decx::_Matrix* src, decx::_Matrix* kernel, decx::_Matrix* dst, 
        de::DH* handle, const int flag);


    static void hConv2_border_ignore(decx::_Matrix& src, decx::_Matrix& kernel, decx::_Matrix& dst, 
        de::DH* handle, const int flag);
}
...
static
void decx::_Conv2_NB_R8x8_fp16(decx::_Matrix* src, decx::_Matrix* kernel, decx::_Matrix* dst, 
    de::DH *handle, const int flag)
{
    float4* Dsrc,
        * Ddst;
...
static
void decx::_Conv2_NB_R16x8_fp16(decx::_Matrix* src, decx::_Matrix* kernel, decx::_Matrix* dst, 
    de::DH *handle, const int flag)
{
    float4* Dsrc, * Ddst;

    int2 Dsrc_alloc_dim, Ddst_alloc_dim, ker_dim;
...
static
void decx::_Conv2_NB_R8x16_fp16(decx::_Matrix* src, decx::_Matrix* kernel, decx::_Matrix* dst, 
    de::DH *handle, const int flag)
{
    float4* Dsrc,
        * Ddst;
...
static
void decx::_Conv2_NB_R16x16_fp16(decx::_Matrix* src, decx::_Matrix* kernel, decx::_Matrix* dst, 
    de::DH *handle, const int flag)
{
    float4* Dsrc,
        * Ddst;
...
static void decx::hConv2_border_ignore(decx::_Matrix& src, decx::_Matrix& kernel, decx::_Matrix& dst, 
    de::DH* handle, const int flag)
{
    int2 half_ker_dim;
    ...
    if (half_ker_dim.x < bounded_kernel_R8 + 1) {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            _Conv2_NB_R8x8_fp16(&src, &kernel, &dst, handle, flag);
        }
        else {
            _Conv2_NB_R16x8_fp16(&src, &kernel, &dst, handle, flag);
        }
    }
    else {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            _Conv2_NB_R8x16_fp16(&src, &kernel, &dst, handle, flag);
        }
        else {
            _Conv2_NB_R16x16_fp16(&src, &kernel, &dst, handle, flag);
        }
    }
}
