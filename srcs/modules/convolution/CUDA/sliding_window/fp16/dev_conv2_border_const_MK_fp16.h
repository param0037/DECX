...
#ifndef _DEV_CONV2_MC_BORDER_CONST_MK_FP16_H_
#define _DEV_CONV2_MC_BORDER_CONST_MK_FP16_H_
...
namespace decx
{
    static void dev_main_loop_hconv2_mk_within8x8_BC(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    ...
    static void dev_main_loop_hconv2_mk_exact8x8_BC(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
        float4* Dsrc, float4* Ddst, decx::cuda_stream* S, const int flag);



    static void dev_main_loop_hconv2_mk_within8x16_BC(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
        float4* Dsrc, float4* Ddst, decx::cuda_stream* S, const int flag);


    static void dev_main_loop_hconv2_mk_exact8x16_BC(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
        float4* Dsrc, float4* Ddst, decx::cuda_stream* S, const int flag);


    static void dev_main_loop_hconv2_mk_within16x8_BC(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
        float4* Dsrc, float4* Ddst, decx::cuda_stream* S, const int flag);


    static void dev_main_loop_hconv2_mk_exact16x8_BC(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
        float4* Dsrc, float4* Ddst, decx::cuda_stream* S, const int flag);


    static void dev_main_loop_hconv2_mk_within16x16_BC(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
        float4* Dsrc, float4* Ddst, decx::cuda_stream* S, const int flag);


    static void dev_main_loop_hconv2_mk_exact16x16_BC(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
        float4* Dsrc, float4* Ddst, decx::cuda_stream* S, const int flag);


    // single kernel
    static void dev_Conv2_BC_R8x8_MK(
        decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst, de::DH *handle, const int flag);


    // single kernel
    static void dev_Conv2_BC_R8x16_MK(
        decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst, de::DH *handle, const int flag);


    // single kernel
    static void dev_Conv2_BC_R16x8_MK(
        decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst, de::DH *handle, const int flag);


    // single kernel
    static void dev_Conv2_BC_R16x16_MK(
        decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst, de::DH *handle, const int flag);


    static void dev_hConv2_border_zero_mk(
        decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst, de::DH* handle, const int flag);
}
...
static void decx::dev_main_loop_hconv2_mk_within8x8_BC(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
    float4* Dsrc, float4* Ddst, decx::cuda_stream* S, const int flag)
{
    int2 src_diff;
    ...
    for (int i = 0; i < src->ArrayNumber; ++i) 
    {
        ...
        for (uint k = 0; k < kernel->height; ++k) {
            cudaMemcpyToSymbolAsync(decx::Const_Mem, (de::Half*)kernel->MatptrArr.ptr[i] + offset_ker,
...
static void decx::dev_main_loop_hconv2_mk_exact8x8_BC(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
    float4* Dsrc, float4* Ddst, decx::cuda_stream* S, const int flag)
{
    size_t offset_lin, offset_ker;
    ...
    {
        checkCudaErrors(cudaMemcpy2DAsync(
            reinterpret_cast<float*>(Dsrc) + Dsrc_alloc_dim->x * bounded_kernel_R8 * 8 + bounded_kernel_R8,
            Dsrc_alloc_dim->x * sizeof(float4),
            src->MatptrArr.ptr[i],
            src->pitch * sizeof(de::Half),
            src->width * sizeof(de::Half),
...
static void decx::dev_main_loop_hconv2_mk_within8x16_BC(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
    float4* Dsrc, float4* Ddst, decx::cuda_stream* S, const int flag)
{
    int2 src_diff;
    ...
    {
        checkCudaErrors(cudaMemcpy2DAsync(
            reinterpret_cast<float*>(Dsrc) + Dsrc_alloc_dim->x * bounded_kernel_R8 * 8 + bounded_kernel_R16,
            Dsrc_alloc_dim->x * sizeof(float4),
            src->MatptrArr.ptr[i],
            src->pitch * sizeof(de::Half),
            src->width * sizeof(de::Half),
...
static void decx::dev_main_loop_hconv2_mk_exact8x16_BC(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
    float4* Dsrc, float4* Ddst, decx::cuda_stream* S, const int flag)
{
    size_t offset_lin, offset_ker;
...
static void decx::dev_main_loop_hconv2_mk_within16x8_BC(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
    float4* Dsrc, float4* Ddst, decx::cuda_stream* S, const int flag)
{
    int2 src_diff;
...
static void decx::dev_main_loop_hconv2_mk_exact16x8_BC(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
    float4* Dsrc, float4* Ddst, decx::cuda_stream* S, const int flag)
{
    size_t offset_lin, offset_ker;
...
static void decx::dev_main_loop_hconv2_mk_within16x16_BC(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
    float4* Dsrc, float4* Ddst, decx::cuda_stream* S, const int flag)
{
    int2 src_diff;
...
static void decx::dev_main_loop_hconv2_mk_exact16x16_BC(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
    float4* Dsrc, float4* Ddst, decx::cuda_stream* S, const int flag)
{
    size_t offset_lin, offset_ker;
...
// single kernel
static void decx::dev_Conv2_BC_R8x8_MK(
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst, de::DH *handle, const int flag)
{
    int2 Dsrc_alloc_dim,
        Ddst_alloc_dim,
    ...
    if (ker_dim.x == (bounded_kernel_R8 * 2 + 1) && ker_dim.y == (bounded_kernel_R8 * 2 + 1)) {
        dev_main_loop_hconv2_mk_exact8x8_BC(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, dev_buffer1.ptr, dev_buffer2.ptr, S, flag);
    }
    else {
        dev_main_loop_hconv2_mk_within8x8_BC(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, dev_buffer1.ptr, dev_buffer2.ptr, S, flag);
    }
...
// single kernel
static void decx::dev_Conv2_BC_R8x16_MK(
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst, de::DH* handle, const int flag)
{
    int2 Dsrc_alloc_dim,
        Ddst_alloc_dim,
    ...
    if (ker_dim.x == (bounded_kernel_R16 * 2 + 1) && ker_dim.y == (bounded_kernel_R8 * 2 + 1)) {
        decx::dev_main_loop_hconv2_mk_exact8x16_BC(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, dev_buffer1.ptr, dev_buffer2.ptr, S, flag);
    }
    else {
        decx::dev_main_loop_hconv2_mk_within8x16_BC(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, dev_buffer1.ptr, dev_buffer2.ptr, S, flag);
    }
...
// single kernel
static void decx::dev_Conv2_BC_R16x8_MK(
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst, de::DH* handle, const int flag)
{
    int2 Dsrc_alloc_dim,
        Ddst_alloc_dim,
    ...
    if (ker_dim.x == (bounded_kernel_R8 * 2 + 1) && ker_dim.y == (bounded_kernel_R16 * 2 + 1)) {
        decx::dev_main_loop_hconv2_mk_exact16x8_BC(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, dev_buffer1.ptr, dev_buffer2.ptr, S, flag);
    }
    else {
        decx::dev_main_loop_hconv2_mk_within16x8_BC(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, dev_buffer1.ptr, dev_buffer2.ptr, S, flag);
    }
...
// single kernel
static void decx::dev_Conv2_BC_R16x16_MK(
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst, de::DH* handle, const int flag)
{
    int2 Dsrc_alloc_dim,
        Ddst_alloc_dim,
    ...
    if (ker_dim.x == (bounded_kernel_R16 * 2 + 1) && ker_dim.y == (bounded_kernel_R16 * 2 + 1)) {
        decx::dev_main_loop_hconv2_mk_exact16x16_BC(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, dev_buffer1.ptr, dev_buffer2.ptr, S, flag);
    }
    else {
        decx::dev_main_loop_hconv2_mk_within16x16_BC(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, dev_buffer1.ptr, dev_buffer2.ptr, S, flag);
    }
...
static void decx::dev_hConv2_border_zero_mk(
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst, de::DH* handle, const int flag)
{
    int2 half_ker_dim;
    ...
    if (half_ker_dim.x < bounded_kernel_R8 + 1) {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            decx::dev_Conv2_BC_R8x8_MK(src, kernel, dst, handle, flag);
        }
        else {
            decx::dev_Conv2_BC_R16x8_MK(src, kernel, dst, handle, flag);
        }
    }
    else {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            decx::dev_Conv2_BC_R8x16_MK(src, kernel, dst, handle, flag);
        }
        else {
            decx::dev_Conv2_BC_R16x16_MK(src, kernel, dst, handle, flag);
        }
    }
}
