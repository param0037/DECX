...
namespace decx
{
    ...
    */
    static void _dev_Conv2_NB_R8x8(decx::_GPU_Matrix* src, decx::_GPU_Matrix* kernel, decx::_GPU_Matrix* dst, de::DH* handle);
    ...
    * In order to save the device memory, just allocate memory of suitable size
    */
    static void _dev_Conv2_NB_R16x16(decx::_GPU_Matrix* src, decx::_GPU_Matrix* kernel, decx::_GPU_Matrix* dst, de::DH* handle);
    ...
    * In order to save the device memory, just allocate memory of suitable size
    */
    static void _dev_Conv2_NB_R8x16(decx::_GPU_Matrix* src, decx::_GPU_Matrix* kernel, decx::_GPU_Matrix* dst, de::DH* handle);
    ...
    * In order to save the device memory, just allocate memory of suitable size
    */
    static void _dev_Conv2_NB_R16x8(decx::_GPU_Matrix* src, decx::_GPU_Matrix* kernel, decx::_GPU_Matrix* dst, de::DH* handle);



    static void dev_sConv2_border_ignore(decx::_GPU_Matrix& src, decx::_GPU_Matrix& kernel, decx::_GPU_Matrix& dst, de::DH* handle);
}




static void decx::_dev_Conv2_NB_R8x8(decx::_GPU_Matrix* src, decx::_GPU_Matrix* kernel, decx::_GPU_Matrix* dst, de::DH* handle)
{
    float4* Dsrc,
        * Ddst;
...
static void decx::_dev_Conv2_NB_R16x16(decx::_GPU_Matrix* src, decx::_GPU_Matrix* kernel, decx::_GPU_Matrix* dst, de::DH* handle)
{
    float4* Dsrc,
        * Ddst;
...
static void decx::_dev_Conv2_NB_R8x16(decx::_GPU_Matrix* src, decx::_GPU_Matrix* kernel, decx::_GPU_Matrix* dst, de::DH* handle)
{
    float4* Dsrc,
        * Ddst;
...
static void decx::_dev_Conv2_NB_R16x8(decx::_GPU_Matrix* src, decx::_GPU_Matrix* kernel, decx::_GPU_Matrix* dst, de::DH* handle)
{
    float4* Dsrc,
        * Ddst;
...
static void decx::dev_sConv2_border_ignore(decx::_GPU_Matrix& src, decx::_GPU_Matrix& kernel, decx::_GPU_Matrix& dst, de::DH* handle)
{
    int2 half_ker_dim;
