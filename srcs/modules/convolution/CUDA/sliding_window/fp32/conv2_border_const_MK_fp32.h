...
namespace decx
{
    ...
    // single kernel
    static void _Conv2_BC_R8x8_MK(decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst);


    // single kernel
    static void _Conv2_BC_R8x16_MK(decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst);


    // single kernel
    static void _Conv2_BC_R16x8_MK(decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst);


    // single kernel
    static void _Conv2_BC_R16x16_MK(decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst);


    static void sConv2_border_zero_mk(decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst, de::DH* handle);
}
...
// single kernel
static void decx::_Conv2_BC_R8x8_MK(decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst)
{
...
// single kernel
static void decx::_Conv2_BC_R8x16_MK(decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst)
{
    decx::alloc::MIF<float4> Dmem1, Dmem2,    // for src
        Dmem3, Dmem4;            // for dst
...
// single kernel
static void decx::_Conv2_BC_R16x8_MK(decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst)
{
    decx::alloc::MIF<float4> Dmem1, Dmem2,    // for src
        Dmem3, Dmem4;            // for dst
...
// single kernel
static void decx::_Conv2_BC_R16x16_MK(decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst)
{
    decx::alloc::MIF<float4> Dmem1, Dmem2,    // for src
        Dmem3, Dmem4;            // for dst
...
static void decx::sConv2_border_zero_mk(decx::_MatrixArray* src, decx::_MatrixArray* kernel, decx::_MatrixArray* dst, de::DH* handle)
{
    int2 half_ker_dim;
