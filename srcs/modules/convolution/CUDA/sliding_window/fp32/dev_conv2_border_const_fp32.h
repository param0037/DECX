...
namespace decx
{
    ...
    */
    static void _dev_Conv2_BC_R8x8(decx::_GPU_Matrix* src, decx::_GPU_Matrix* kernel, decx::_GPU_Matrix* dst, de::DH* handle);
    ...
    * In order to save the device memory, just allocate memory of suitable size
    */
    static void _dev_Conv2_BC_R8x16(decx::_GPU_Matrix* src, decx::_GPU_Matrix* kernel, decx::_GPU_Matrix* dst, de::DH* handle);
    ...
    * In order to save the device memory, just allocate memory of suitable size
    */
    static void _dev_Conv2_BC_R16x8(decx::_GPU_Matrix* src, decx::_GPU_Matrix* kernel, decx::_GPU_Matrix* dst, de::DH* handle);
    ...
    * In order to save the device memory, just allocate memory of suitable size
    */
    static void _dev_Conv2_BC_R16x16(decx::_GPU_Matrix* src, decx::_GPU_Matrix* kernel, decx::_GPU_Matrix* dst, de::DH* handle);



    static void dev_sConv2_border_zero(decx::_GPU_Matrix& src, decx::_GPU_Matrix& kernel, decx::_GPU_Matrix& dst, de::DH* handle);
}
...
static
void decx::_dev_Conv2_BC_R8x8(decx::_GPU_Matrix* src, decx::_GPU_Matrix* kernel, decx::_GPU_Matrix* dst, de::DH *handle)
{
    float4* Dsrc,
        *Ddst;
    ...
    for (int i = 0; i < kernel->height; ++i) {
        cudaMemcpyToSymbolAsync(decx::Const_Mem,
            (float*)kernel->Mat.ptr + offset_ker,
            kernel->width * sizeof(float),
            offset_lin * sizeof(float), cudaMemcpyDeviceToDevice, S->get_raw_stream_ref());
...
static
void decx::_dev_Conv2_BC_R8x16(decx::_GPU_Matrix* src, decx::_GPU_Matrix* kernel, decx::_GPU_Matrix* dst, de::DH *handle)
{
    float4* Dsrc,
        *Ddst;
...
static
void decx::_dev_Conv2_BC_R16x8(decx::_GPU_Matrix* src, decx::_GPU_Matrix* kernel, decx::_GPU_Matrix* dst, de::DH *handle)
{
    float4* Dsrc,
        *Ddst;
...
static
void decx::_dev_Conv2_BC_R16x16(decx::_GPU_Matrix* src, decx::_GPU_Matrix* kernel, decx::_GPU_Matrix* dst, de::DH *handle)
{
    float4* Dsrc,
        * Ddst;
...
static 
void decx::dev_sConv2_border_zero(decx::_GPU_Matrix& src, decx::_GPU_Matrix& kernel, decx::_GPU_Matrix& dst, de::DH* handle)
{
    int2 half_ker_dim;
    ...
    dst.re_construct(src.type, src.width, dst.height);

    if (half_ker_dim.x < bounded_kernel_R8 + 1) {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            decx::_dev_Conv2_BC_R8x8(&src, &kernel, &dst, handle);
        }
        else {
            decx::_dev_Conv2_BC_R16x8(&src, &kernel, &dst, handle);
        }
    }
    else {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            decx::_dev_Conv2_BC_R8x16(&src, &kernel, &dst, handle);
        }
        else {
            decx::_dev_Conv2_BC_R16x16(&src, &kernel, &dst, handle);
        }
    }
    decx::Success(handle);
}
...
#endif        // #ifndef _DEV_CONV2_BORDER_CONSTANT_H_