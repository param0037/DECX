...
namespace decx
{
    ...
    // single kernel
    static void _Conv2_NB_R8x8_SK(decx::_MatrixArray* src, decx::_Matrix* kernel, decx::_MatrixArray* dst);


    // single kernel
    static void _Conv2_NB_R8x16_SK(decx::_MatrixArray* src, decx::_Matrix* kernel, decx::_MatrixArray* dst);


    // single kernel
    static void _Conv2_NB_R16x8_SK(decx::_MatrixArray* src, decx::_Matrix* kernel, decx::_MatrixArray* dst);


    // single kernel
    static void _Conv2_NB_R16x16_SK(decx::_MatrixArray* src, decx::_Matrix* kernel, decx::_MatrixArray* dst);


    static void sConv2_border_ignore_sk(decx::_MatrixArray* src, decx::_Matrix* kernel, decx::_MatrixArray* dst, de::DH* handle);
}
...
// single kernel
static void decx::_Conv2_NB_R8x8_SK(decx::_MatrixArray* src, decx::_Matrix* kernel, decx::_MatrixArray* dst)
{
...
// single kernel
static void decx::_Conv2_NB_R8x16_SK(decx::_MatrixArray* src, decx::_Matrix* kernel, decx::_MatrixArray* dst)
{
    decx::alloc::MIF<float4> Dmem1, Dmem2,    // for src
        Dmem3, Dmem4;            // for dst
...
// single kernel
static void decx::_Conv2_NB_R16x8_SK(decx::_MatrixArray* src, decx::_Matrix* kernel, decx::_MatrixArray* dst)
{
    decx::alloc::MIF<float4> Dmem1, Dmem2,    // for src
        Dmem3, Dmem4;            // for dst
...
// single kernel
static void decx::_Conv2_NB_R16x16_SK(decx::_MatrixArray* src, decx::_Matrix* kernel, decx::_MatrixArray* dst)
{
    decx::alloc::MIF<float4> Dmem1, Dmem2,    // for src
        Dmem3, Dmem4;            // for dst
...
static void decx::sConv2_border_ignore_sk(decx::_MatrixArray* src, decx::_Matrix* kernel, decx::_MatrixArray* dst, de::DH* handle)
{
    int2 half_ker_dim;
    ...
    if (half_ker_dim.x < bounded_kernel_R8 + 1) {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            decx::_Conv2_NB_R8x8_SK(src, kernel, dst);
        }
        else {
            decx::_Conv2_NB_R16x8_SK(src, kernel, dst);
        }
    }
    else {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            decx::_Conv2_NB_R8x16_SK(src, kernel, dst);
        }
        else {
            decx::_Conv2_NB_R16x16_SK(src, kernel, dst);
        }
    }
}
