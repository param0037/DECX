...
#ifndef _DEV_CONV2_MC_BORDER_CONST_SK_FP32_H_
#define _DEV_CONV2_MC_BORDER_CONST_SK_FP32_H_
...
namespace decx
{
    static void dev_main_loop_sconv2_sk_within8x8_BC(
    ...
    static void dev_main_loop_sconv2_sk_exact8x8_BC(
        int2* Dsrc_alloc_dim,                int2* Ddst_alloc_dim,                int2* ker_dim,
        decx::_GPU_MatrixArray* src,        decx::_GPU_Matrix* kernel,            decx::_GPU_MatrixArray* dst,
        float4* Dsrc,                        float4* Ddst,                        decx::cuda_stream* S);
    ...
    static void dev_main_loop_sconv2_sk_within8x16_BC(
        int2* Dsrc_alloc_dim,                int2* Ddst_alloc_dim,                int2* ker_dim,
        decx::_GPU_MatrixArray* src,        decx::_GPU_Matrix* kernel,            decx::_GPU_MatrixArray* dst,
        float4* Dsrc,                        float4* Ddst,                        decx::cuda_stream* S);


    static void dev_main_loop_sconv2_sk_exact8x16_BC(
        int2* Dsrc_alloc_dim,                int2* Ddst_alloc_dim,                int2* ker_dim,
        decx::_GPU_MatrixArray* src,        decx::_GPU_Matrix* kernel,            decx::_GPU_MatrixArray* dst,
        float4* Dsrc,                        float4* Ddst,                        decx::cuda_stream* S);


    static void dev_main_loop_sconv2_sk_within16x8_BC(
        int2* Dsrc_alloc_dim,                int2* Ddst_alloc_dim,                int2* ker_dim,
        decx::_GPU_MatrixArray* src,        decx::_GPU_Matrix* kernel,            decx::_GPU_MatrixArray* dst,
        float4* Dsrc,                        float4* Ddst,                        decx::cuda_stream* S);


    static void dev_main_loop_sconv2_sk_exact16x8_BC(
        int2* Dsrc_alloc_dim,                int2* Ddst_alloc_dim,                int2* ker_dim,
        decx::_GPU_MatrixArray* src,        decx::_GPU_Matrix* kernel,            decx::_GPU_MatrixArray* dst,
        float4* Dsrc,                        float4* Ddst,                        decx::cuda_stream* S);


    static void dev_main_loop_sconv2_sk_within16x16_BC(
        int2* Dsrc_alloc_dim,                int2* Ddst_alloc_dim,                int2* ker_dim,
        decx::_GPU_MatrixArray* src,        decx::_GPU_Matrix* kernel,            decx::_GPU_MatrixArray* dst,
        float4* Dsrc,                        float4* Ddst,                        decx::cuda_stream* S);


    static void dev_main_loop_sconv2_sk_exact16x16_BC(
        int2* Dsrc_alloc_dim,                int2* Ddst_alloc_dim,                int2* ker_dim,
        decx::_GPU_MatrixArray* src,        decx::_GPU_Matrix* kernel,            decx::_GPU_MatrixArray* dst,
        float4* Dsrc,                        float4* Ddst,                        decx::cuda_stream* S);
    ...
    // single kernel
    static void dev_Conv2_BC_R8x8_SK(decx::_GPU_MatrixArray* src, decx::_GPU_Matrix* kernel, decx::_GPU_MatrixArray* dst);


    // single kernel
    static void dev_Conv2_BC_R8x16_SK(decx::_GPU_MatrixArray* src, decx::_GPU_Matrix* kernel, decx::_GPU_MatrixArray* dst);


    // single kernel
    static void dev_Conv2_BC_R16x8_SK(decx::_GPU_MatrixArray* src, decx::_GPU_Matrix* kernel, decx::_GPU_MatrixArray* dst);


    // single kernel
    static void dev_Conv2_BC_R16x16_SK(decx::_GPU_MatrixArray* src, decx::_GPU_Matrix* kernel, decx::_GPU_MatrixArray* dst);


    static void dev_sConv2_border_zero_sk(decx::_GPU_MatrixArray* src, decx::_GPU_Matrix* kernel, decx::_GPU_MatrixArray* dst, de::DH* handle);
}




static void decx::dev_main_loop_sconv2_sk_within8x8_BC(
        int2* Dsrc_alloc_dim,                int2* Ddst_alloc_dim,                int2* ker_dim,
        decx::_GPU_MatrixArray* src,        decx::_GPU_Matrix* kernel,            decx::_GPU_MatrixArray* dst,
        float4* Dsrc,                        float4* Ddst,                        decx::cuda_stream* S)
{
...
static void decx::dev_main_loop_sconv2_sk_exact8x8_BC(
        int2* Dsrc_alloc_dim,                int2* Ddst_alloc_dim,                int2* ker_dim,
        decx::_GPU_MatrixArray* src,        decx::_GPU_Matrix* kernel,            decx::_GPU_MatrixArray* dst,
        float4* Dsrc,                        float4* Ddst,                        decx::cuda_stream* S)
{
...
static void decx::dev_main_loop_sconv2_sk_within8x16_BC(
        int2* Dsrc_alloc_dim,                int2* Ddst_alloc_dim,                int2* ker_dim,
        decx::_GPU_MatrixArray* src,        decx::_GPU_Matrix* kernel,            decx::_GPU_MatrixArray* dst,
        float4* Dsrc,                        float4* Ddst,                        decx::cuda_stream* S)
{
...
static void decx::dev_main_loop_sconv2_sk_exact8x16_BC(
        int2* Dsrc_alloc_dim,                int2* Ddst_alloc_dim,                int2* ker_dim,
        decx::_GPU_MatrixArray* src,        decx::_GPU_Matrix* kernel,            decx::_GPU_MatrixArray* dst,
        float4* Dsrc,                        float4* Ddst,                        decx::cuda_stream* S)
{
...
static void decx::dev_main_loop_sconv2_sk_within16x8_BC(
        int2* Dsrc_alloc_dim,                int2* Ddst_alloc_dim,                int2* ker_dim,
        decx::_GPU_MatrixArray* src,        decx::_GPU_Matrix* kernel,            decx::_GPU_MatrixArray* dst,
        float4* Dsrc,                        float4* Ddst,                        decx::cuda_stream* S)
{
...
static void decx::dev_main_loop_sconv2_sk_exact16x8_BC(
        int2* Dsrc_alloc_dim,                int2* Ddst_alloc_dim,                int2* ker_dim,
        decx::_GPU_MatrixArray* src,        decx::_GPU_Matrix* kernel,            decx::_GPU_MatrixArray* dst,
        float4* Dsrc,                        float4* Ddst,                        decx::cuda_stream* S)
{
...
static void decx::dev_main_loop_sconv2_sk_within16x16_BC(
        int2* Dsrc_alloc_dim,                int2* Ddst_alloc_dim,                int2* ker_dim,
        decx::_GPU_MatrixArray* src,        decx::_GPU_Matrix* kernel,            decx::_GPU_MatrixArray* dst,
        float4* Dsrc,                        float4* Ddst,                        decx::cuda_stream* S)
{
...
static void decx::dev_main_loop_sconv2_sk_exact16x16_BC(
        int2* Dsrc_alloc_dim,                int2* Ddst_alloc_dim,                int2* ker_dim,
        decx::_GPU_MatrixArray* src,        decx::_GPU_Matrix* kernel,            decx::_GPU_MatrixArray* dst,
        float4* Dsrc,                        float4* Ddst,                        decx::cuda_stream* S)
{
...
// single kernel
static void decx::dev_Conv2_BC_R8x8_SK(decx::_GPU_MatrixArray* src, decx::_GPU_Matrix* kernel, decx::_GPU_MatrixArray* dst)
{
    int2 Dsrc_alloc_dim,
        Ddst_alloc_dim,
        ker_dim;
    ...
    if (ker_dim.x == (bounded_kernel_R8 * 2 + 1) && ker_dim.y == (bounded_kernel_R8 * 2 + 1)) {
        decx::dev_main_loop_sconv2_sk_exact8x8_BC(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, Dsrc, Ddst, S);
    }
    else {
        decx::dev_main_loop_sconv2_sk_within8x8_BC(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, Dsrc, Ddst, S);
    }
...
// single kernel
static void decx::dev_Conv2_BC_R8x16_SK(decx::_GPU_MatrixArray* src, decx::_GPU_Matrix* kernel, decx::_GPU_MatrixArray* dst)
{
    int2 Dsrc_alloc_dim,
        Ddst_alloc_dim,
        ker_dim;
    ...
    if (ker_dim.x == (bounded_kernel_R16 * 2 + 1) && ker_dim.y == (bounded_kernel_R8 * 2 + 1)) {
        decx::dev_main_loop_sconv2_sk_exact8x16_BC(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, Dsrc, Ddst, S);
    }
    else {
        decx::dev_main_loop_sconv2_sk_within8x16_BC(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, Dsrc, Ddst, S);
    }
    checkCudaErrors(cudaDeviceSynchronize());
...
// single kernel
static void decx::dev_Conv2_BC_R16x8_SK(decx::_GPU_MatrixArray* src, decx::_GPU_Matrix* kernel, decx::_GPU_MatrixArray* dst)
{
    ...
    if (ker_dim.x == (bounded_kernel_R8 * 2 + 1) && ker_dim.y == (bounded_kernel_R16 * 2 + 1)) {
        decx::dev_main_loop_sconv2_sk_exact16x8_BC(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, Dsrc, Ddst, S);
    }
    else {
        decx::dev_main_loop_sconv2_sk_within16x8_BC(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, Dsrc, Ddst, S);
    }
    checkCudaErrors(cudaDeviceSynchronize());
...
// single kernel
static void decx::dev_Conv2_BC_R16x16_SK(decx::_GPU_MatrixArray* src, decx::_GPU_Matrix* kernel, decx::_GPU_MatrixArray* dst)
{
    MIF<float4> Dmem1, Dmem2,    // for src
        Dmem3, Dmem4;            // for dst
    ...
    if (ker_dim.x == (bounded_kernel_R16 * 2 + 1) && ker_dim.y == (bounded_kernel_R16 * 2 + 1)) {
        decx::dev_main_loop_sconv2_sk_exact16x16_BC(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, Dsrc, Ddst, S);
    }
    else {
        decx::dev_main_loop_sconv2_sk_within16x16_BC(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, Dsrc, Ddst, S);
    }
    checkCudaErrors(cudaDeviceSynchronize());
...
static void decx::dev_sConv2_border_zero_sk(decx::_GPU_MatrixArray* src, decx::_GPU_Matrix* kernel, decx::_GPU_MatrixArray* dst, de::DH* handle)
{
    int2 half_ker_dim;
