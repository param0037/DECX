...
namespace decx
{
    ...
    */
        ...
        decx::cuda_stream* S)    noexcept
    {
        ...
        cu_sConv2_r8_within_offset << <blocks, threads, 0, S->get_raw_stream_ref() >> > (
    ...
    */
        ...
        decx::cuda_stream* S)    noexcept
    {
        ...
        cu_sConv2_r8_exact << <blocks, threads, 0, S->get_raw_stream_ref() >> > (
            Dsrc, Ddst, src_dim.x, dst_dim.x, ker_dim.x * ker_dim.y, ker_dim.x);
    }


    static inline void sconv2_kernel_exact8x8_v2(float4* Dsrc,
        float4* Ddst,
        const int2            src_dim,
        const int2            dst_dim,
        const int2            ker_dim,
        const size_t pitch_src,
        ...
        decx::cuda_stream* S)    noexcept
    {
        ...
        cu_sConv2_r8_exact << <blocks, threads, 0, S->get_raw_stream_ref() >> > (
            Dsrc, Ddst, pitch_src, pitch_dst, ker_dim.x * ker_dim.y, ker_dim.x);
    }
        ...
        decx::cuda_stream* S)    noexcept
    {
        ...
        cu_sConv2_r8_exact_offset << <blocks, threads, 0, S->get_raw_stream_ref() >> > (
    ...
    */
        ...
        decx::cuda_stream* S)    noexcept
    {
        ...
        cu_sConv2_r16_exact << <blocks, threads, 0, S->get_raw_stream_ref() >> > (
            Dsrc, Ddst, src_dim.x, dst_dim.x, ker_dim.x * ker_dim.y, ker_dim.x);
    }
        ...
        decx::cuda_stream* S)    noexcept
    {
        ...
        cu_sConv2_r16_exact_offset << <blocks, threads, 0, S->get_raw_stream_ref() >> > (
            Dsrc, Ddst, src_dim.x, dst_dim.x, ker_dim.x * ker_dim.y, ker_dim.x, offset);
    }
    ...
    */
        ...
        decx::cuda_stream* S)    noexcept
    {
        ...
        cu_sConv2_r16_within << <blocks, threads, 0, S->get_raw_stream_ref() >> > (
            Dsrc, Ddst, src_dim.x, dst_dim.x, ker_dim.x * ker_dim.y, ker_dim.x, kernel_shift);
    }
        ...
        decx::cuda_stream* S)    noexcept
    {
        ...
        cu_sConv2_r16_within_offset << <blocks, threads, 0, S->get_raw_stream_ref() >> > (
            Dsrc, Ddst, src_dim.x, dst_dim.x, ker_dim.x * ker_dim.y, ker_dim.x, kernel_shift, offset);
    }
    ...
    */
        ...
        decx::cuda_stream* S)    noexcept
    {
        ...
        cu_sConv2_r816_exact << <blocks, threads, 0, S->get_raw_stream_ref() >> > (
            Dsrc, Ddst, src_dim.x, dst_dim.x, ker_dim.x * ker_dim.y, ker_dim.x);
    }
        ...
        decx::cuda_stream* S)    noexcept
    {
        ...
        cu_sConv2_r816_exact_offset << <blocks, threads, 0, S->get_raw_stream_ref() >> > (
            Dsrc, Ddst, src_dim.x, dst_dim.x, ker_dim.x * ker_dim.y, ker_dim.x, offset);
    }
    ...
    */
        ...
        decx::cuda_stream* S)    noexcept
    {
        ...
        cu_sConv2_r816_within << <blocks, threads, 0, S->get_raw_stream_ref() >> > (
            Dsrc, Ddst, src_dim.x, dst_dim.x, ker_dim.x * ker_dim.y, ker_dim.x, kernel_shift);
    }
        ...
        decx::cuda_stream* S)    noexcept
    {
        ...
        cu_sConv2_r816_within_offset << <blocks, threads, 0, S->get_raw_stream_ref() >> > (
            Dsrc, Ddst, src_dim.x, dst_dim.x, ker_dim.x * ker_dim.y, ker_dim.x, kernel_shift, offset);
    }
    ...
    */
        ...
        decx::cuda_stream* S)    noexcept
    {
        ...
        cu_sConv2_r168_exact << <blocks, threads, 0, S->get_raw_stream_ref() >> > (
            Dsrc, Ddst, src_dim.x, dst_dim.x, ker_dim.x * ker_dim.y, ker_dim.x);
    }
        ...
        decx::cuda_stream* S)    noexcept
    {
        ...
        cu_sConv2_r168_exact_offset << <blocks, threads, 0, S->get_raw_stream_ref() >> > (
            Dsrc, Ddst, src_dim.x, dst_dim.x, ker_dim.x * ker_dim.y, ker_dim.x, offset);
    }
    ...
    */
        ...
        decx::cuda_stream* S)    noexcept
    {
        ...
        cu_sConv2_r168_within << <blocks, threads, 0, S->get_raw_stream_ref() >> > (
            Dsrc, Ddst, src_dim.x, dst_dim.x, ker_dim.x * ker_dim.y, ker_dim.x, kernel_shift);
    }
        ...
        decx::cuda_stream* S)    noexcept
    {
        ...
        cu_sConv2_r168_within_offset << <blocks, threads, 0, S->get_raw_stream_ref() >> > (
            Dsrc, Ddst, src_dim.x, dst_dim.x, ker_dim.x * ker_dim.y, ker_dim.x, kernel_shift, offset);
    }
}
