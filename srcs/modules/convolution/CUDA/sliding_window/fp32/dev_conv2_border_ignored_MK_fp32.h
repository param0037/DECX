...
#ifndef _DEV_CONV2_BORDER_IGNORED_MK_FP32_H_
#define _DEV_CONV2_BORDER_IGNORED_MK_FP32_H_
...
namespace decx
{
    static void dev_main_loop_sconv2_mk_within8x8_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    ...
    static void dev_main_loop_sconv2_mk_exact8x8_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
        float4* Dsrc, float4* Ddst,
        decx::cuda_stream* S);
    ...
    static void dev_main_loop_sconv2_mk_within8x16_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
        float4* Dsrc, float4* Ddst,
        decx::cuda_stream* S);


    static void dev_main_loop_sconv2_mk_exact8x16_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
        float4* Dsrc, float4* Ddst,
        decx::cuda_stream* S);


    static void dev_main_loop_sconv2_mk_within16x8_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
        float4* Dsrc, float4* Ddst,
        decx::cuda_stream* S);


    static void dev_main_loop_sconv2_mk_exact16x8_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
        float4* Dsrc, float4* Ddst,
        decx::cuda_stream* S);


    static void dev_main_loop_sconv2_mk_within16x16_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
        float4* Dsrc, float4* Ddst,
        decx::cuda_stream* S);


    static void dev_main_loop_sconv2_mk_exact16x16_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
        float4* Dsrc, float4* Ddst,
        decx::cuda_stream* S);
    ...
    // single kernel
    static void dev_Conv2_NB_R8x8_MK(decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst);


    // single kernel
    static void dev_Conv2_NB_R8x16_MK(decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst);


    // single kernel
    static void dev_Conv2_NB_R16x8_MK(decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst);


    // single kernel
    static void dev_Conv2_NB_R16x16_MK(decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst);


    static void dev_sConv2_border_ignore_mk(decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst, de::DH* handle);
}
...
static void decx::dev_main_loop_sconv2_mk_within8x8_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
    float4* Dsrc, float4* Ddst,
    decx::cuda_stream* S)
{
    ...
    for (int i = 0; i < src->ArrayNumber; ++i) 
    {
        checkCudaErrors(cudaMemcpy2DAsync(
            reinterpret_cast<float*>(Dsrc) + Dsrc_alloc_dim->x * src_diff.x * 4 + src_diff.y,
...
static void decx::dev_main_loop_sconv2_mk_exact8x8_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
    float4* Dsrc, float4* Ddst,
    decx::cuda_stream* S)
{
...
static void decx::dev_main_loop_sconv2_mk_within8x16_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
    float4* Dsrc, float4* Ddst,
    decx::cuda_stream* S)
{
...
static void decx::dev_main_loop_sconv2_mk_exact8x16_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
    float4* Dsrc, float4* Ddst,
    decx::cuda_stream* S)
{
...
static void decx::dev_main_loop_sconv2_mk_within16x8_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
    float4* Dsrc, float4* Ddst,
    decx::cuda_stream* S)
{
...
static void decx::dev_main_loop_sconv2_mk_exact16x8_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
    float4* Dsrc, float4* Ddst,
    decx::cuda_stream* S)
{
...
static void decx::dev_main_loop_sconv2_mk_within16x16_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
    float4* Dsrc, float4* Ddst,
    decx::cuda_stream* S)
{
...
static void decx::dev_main_loop_sconv2_mk_exact16x16_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
    decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst,
    float4* Dsrc, float4* Ddst,
    decx::cuda_stream* S)
{
...
// single kernel
static void decx::dev_Conv2_NB_R8x8_MK(decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst)
{
    int2 Dsrc_alloc_dim,
        Ddst_alloc_dim,
        ker_dim;
...
// single kernel
static void decx::dev_Conv2_NB_R8x16_MK(decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst)
{
    int2 Dsrc_alloc_dim,
        Ddst_alloc_dim,
        ker_dim;
    ...
    if (ker_dim.x == (bounded_kernel_R16 * 2 + 1) && ker_dim.y == (bounded_kernel_R8 * 2 + 1)) {
        decx::dev_main_loop_sconv2_mk_exact8x16_NB(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, dev_buffer1.ptr, dev_buffer2.ptr, S);
    }
    else {
        decx::dev_main_loop_sconv2_mk_within8x16_NB(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, dev_buffer1.ptr, dev_buffer2.ptr, S);
    }
    checkCudaErrors(cudaDeviceSynchronize());
    decx::alloc::_device_dealloc(&dev_buffer1);
...
// single kernel
static void decx::dev_Conv2_NB_R16x8_MK(decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst)
{
    int2 Dsrc_alloc_dim,
        Ddst_alloc_dim,
        ker_dim;
    ...
    if (ker_dim.x == (bounded_kernel_R8 * 2 + 1) && ker_dim.y == (bounded_kernel_R16 * 2 + 1)) {
        decx::dev_main_loop_sconv2_mk_exact16x8_NB(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, dev_buffer1.ptr, dev_buffer2.ptr, S);
    }
    else {
        decx::dev_main_loop_sconv2_mk_within16x8_NB(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, dev_buffer1.ptr, dev_buffer2.ptr, S);
    }
    checkCudaErrors(cudaDeviceSynchronize());
    decx::alloc::_device_dealloc(&dev_buffer1);
...
// single kernel
static void decx::dev_Conv2_NB_R16x16_MK(decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst)
{
    int2 Dsrc_alloc_dim,
        Ddst_alloc_dim,
        ker_dim;
    ...
    if (ker_dim.x == (bounded_kernel_R16 * 2 + 1) && ker_dim.y == (bounded_kernel_R16 * 2 + 1)) {
        decx::dev_main_loop_sconv2_mk_exact16x16_NB(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, dev_buffer1.ptr, dev_buffer2.ptr, S);
    }
    else {
        decx::dev_main_loop_sconv2_mk_within16x16_NB(
            &Dsrc_alloc_dim, &Ddst_alloc_dim, &ker_dim, src, kernel, dst, dev_buffer1.ptr, dev_buffer2.ptr, S);
    }
    checkCudaErrors(cudaDeviceSynchronize());
    decx::alloc::_device_dealloc(&dev_buffer1);
...
static void decx::dev_sConv2_border_ignore_mk(decx::_GPU_MatrixArray* src, decx::_GPU_MatrixArray* kernel, decx::_GPU_MatrixArray* dst, de::DH* handle)
{
    int2 half_ker_dim;
    ...
    if (half_ker_dim.x < bounded_kernel_R8 + 1) {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            decx::dev_Conv2_NB_R8x8_MK(src, kernel, dst);
        }
        else {
            decx::dev_Conv2_NB_R16x8_MK(src, kernel, dst);
        }
    }
    else {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            decx::dev_Conv2_NB_R8x16_MK(src, kernel, dst);
        }
        else {
            decx::dev_Conv2_NB_R16x16_MK(src, kernel, dst);
        }
    }
    decx::Success(handle);
}
