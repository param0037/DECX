...
namespace decx
{
    namespace cuda
    {
        void Conv2_single_kernel_fp32(
            de::MatrixArray& src, de::Matrix& kernel, de::MatrixArray& dst, const int flag, de::DH* handle);



        void Conv2_single_kernel_fp16(
            de::MatrixArray& src, de::Matrix& kernel, de::MatrixArray& dst, const int conv_flag, const int accu_flag, de::DH* handle);



        void Conv2_multi_kernel_fp32(
            de::MatrixArray& src, de::MatrixArray& kernel, de::MatrixArray& dst, const int flag, de::DH* handle);



        void Conv2_multi_kernel_fp16(
            de::MatrixArray& src, de::MatrixArray& kernel, de::MatrixArray& dst, const int conv_flag, const int accu_flag, de::DH* handle);
    }
}



void decx::cuda::Conv2_single_kernel_fp32(de::MatrixArray& src, de::Matrix& kernel, de::MatrixArray& dst, const int flag, de::DH* handle)
{
...
void decx::cuda::Conv2_single_kernel_fp16(
    de::MatrixArray& src, de::Matrix& kernel, de::MatrixArray& dst, const int conv_flag, const int accu_flag, de::DH* handle)
{
    decx::_MatrixArray* _src = dynamic_cast<decx::_MatrixArray*>(&src);
    decx::_Matrix* _kernel = dynamic_cast<decx::_Matrix*>(&kernel);
    ...
    {
    case decx::conv_property::de_conv_no_compensate:
        decx::hConv2_border_ignore_sk(_src, _kernel, _dst, handle, accu_flag);
        break;

    case decx::conv_property::de_conv_zero_compensate:
        decx::hConv2_border_zero_sk(_src, _kernel, _dst, handle, accu_flag);
        break;
    default:
        break;
    }
...
void decx::cuda::Conv2_multi_kernel_fp32(
    de::MatrixArray& src, de::MatrixArray& kernel, de::MatrixArray& dst, const int flag, de::DH *handle)
{
    decx::_MatrixArray* _src = dynamic_cast<decx::_MatrixArray*>(&src);
...
void decx::cuda::Conv2_multi_kernel_fp16(
    de::MatrixArray& src, de::MatrixArray& kernel, de::MatrixArray& dst, const int conv_flag, const int accu_flag, de::DH* handle)
{
    decx::_MatrixArray* _src = dynamic_cast<decx::_MatrixArray*>(&src);
    decx::_MatrixArray* _kernel = dynamic_cast<decx::_MatrixArray*>(&kernel);
    ...
    {
    case decx::conv_property::de_conv_no_compensate:
        decx::hConv2_border_ignore_mk(_src, _kernel, _dst, handle, accu_flag);
        break;

    case decx::conv_property::de_conv_zero_compensate:
        decx::hConv2_border_zero_mk(_src, _kernel, _dst, handle, accu_flag);
        break;
    default:
        break;
    }
    ...
    de::MatrixArray& src, de::Matrix& kernel, de::MatrixArray& dst, const int conv_flag, const int accu_flag)
{
    ...
    case decx::_DATA_TYPES_FLAGS_::_FP32_:
        decx::cuda::Conv2_single_kernel_fp32(src, kernel, dst, conv_flag, &handle);
        break;
    case decx::_DATA_TYPES_FLAGS_::_FP16_:
        decx::cuda::Conv2_single_kernel_fp16(src, kernel, dst, conv_flag, accu_flag, &handle);
        break;
    default:
        break;
    }
    ...
    de::MatrixArray& src, de::MatrixArray& kernel, de::MatrixArray& dst, const int conv_flag, const int accu_flag)
{
    ...
    {
    case decx::_DATA_TYPES_FLAGS_::_FP32_:
        decx::cuda::Conv2_multi_kernel_fp32(src, kernel, dst, conv_flag, &handle);
        break;
    case decx::_DATA_TYPES_FLAGS_::_FP16_:
        decx::cuda::Conv2_multi_kernel_fp16(src, kernel, dst, conv_flag, accu_flag, &handle);
        break;
    default:
        break;
    }
